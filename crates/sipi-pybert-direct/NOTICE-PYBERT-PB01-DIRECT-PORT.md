...
`src/legacy_runtime.rs`, the PB-01 fixture, and the pickle/YAML dependencies.
...
legacy YAML field names, default result suffix, native metallic-line leaf, and
canonical `PyBertData` item names. It is not a copy of the upstream Python
source, and it does not include the upstream pickle payload or runtime assets.
