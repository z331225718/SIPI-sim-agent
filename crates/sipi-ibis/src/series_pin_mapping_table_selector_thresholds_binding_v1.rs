//! Typed IBIS [Series Pin Mapping] Model Selector threshold table binding core (P4A-03bg).
//!
...
pub const SERIES_PIN_TABLE_SELECTOR_THRESHOLDS_POLICY_V1: &str =
    "sipi.p4a-03bg.series-pin-table-selector-thresholds-v1.typed-selector-thresholds";
