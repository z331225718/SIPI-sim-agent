//! Typed IBIS [Series Pin Mapping] Model Selector group threshold table binding core (P4A-03au).
//!
...
pub const SERIES_PIN_TABLE_SELECTOR_THRESHOLDS_GROUP_POLICY_V1: &str =
    "sipi.p4a-03au.series-pin-table-selector-thresholds-group-v1.typed-selector-thresholds-group";
