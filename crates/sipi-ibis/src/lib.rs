#![forbid(unsafe_code)]
// Several typed record constructors mirror fixed IBIS table columns.
...
pub use bus_label_declaration_v1::{
    BUS_LABEL_DECLARATION_POLICY_V1, BusLabelDeclarationErrorV1, TypedBusLabelDeclarationV1,
    lift_bus_label_declaration_v1,
};
pub use bus_label_keywords_v1::{
    BUS_LABEL_KEYWORDS_POLICY_V1, BusLabelKeywordsErrorV1, TypedBusLabelBlockV1,
    lift_bus_label_block_v1,
};
pub use circuit_call_declaration_v1::{
    CIRCUIT_CALL_DECLARATION_POLICY_V1, CircuitCallDeclarationErrorV1, PortMapV1,
    TypedCircuitCallDeclarationV1, lift_circuit_call_declaration_v1,
};
pub use component_declaration_v1::{
    COMPONENT_DECLARATION_POLICY_V1, ComponentDeclarationErrorV1, IbisComponentV1,
    lift_component_declaration_v1,
};
pub use diff_pin_declaration_v1::{
    DIFF_PIN_DECLARATION_POLICY_V1, DiffPinDeclarationErrorV1, TypedDiffPinDeclarationV1,
    lift_diff_pin_declaration_v1,
};
pub use diff_pin_keywords_v1::{
    DIFF_PIN_KEYWORDS_POLICY_V1, DiffPinKeywordsErrorV1, TypedDiffPinBlockV1,
    lift_diff_pin_block_v1,
};
pub use golden_wave_declaration_v1::{
    GOLDEN_WAVE_DECLARATION_POLICY_V1, GoldenWaveDeclarationErrorV1, TypedGoldenWaveDeclarationV1,
    lift_golden_wave_declaration_v1,
};
pub use golden_wave_keywords_v1::{
    GOLDEN_WAVE_KEYWORDS_POLICY_V1, GoldenWaveKeywordsErrorV1, TypedGoldenWaveBlockV1,
    lift_golden_wave_block_v1,
};
pub use model_declaration_keywords_v1::{
    MODEL_DECLARATION_KEYWORDS_POLICY_V1, ModelDeclarationKeywordsErrorV1, ModelSubKeywordsV1,
    validate_model_keywords_v1,
};
pub use model_declaration_v1::{
    MODEL_DECLARATION_POLICY_V1, ModelDeclarationErrorV1, ModelTypeV1, TypedModelDeclarationV1,
    lift_model_declarations_v1,
};
pub use model_selector_declaration_v1::{
    MODEL_SELECTOR_DECLARATION_POLICY_V1, ModelBranchV1, ModelSelectorDeclarationErrorV1,
    TypedModelSelectorDeclarationV1, TypedSeriesPinMappingV1, lift_model_selector_declaration_v1,
    lift_series_pin_mapping_v1,
};
pub use model_selector_keywords_v1::{
    MODEL_SELECTOR_KEYWORDS_POLICY_V1, ModelOptionEntryV1, ModelSelectorKeywordsErrorV1,
    TypedModelSelectorKeywordsV1, lift_model_selector_keywords_v1,
};
pub use node_declaration_v1::{
    NODE_DECLARATION_POLICY_V1, NodeDeclarationErrorV1, TypedNodeDeclarationV1,
    lift_node_declaration_v1,
};
pub use package_model_declaration_v1::{
    PACKAGE_MODEL_DECLARATION_POLICY_V1, PackageModelDeclarationErrorV1,
    TypedPackageModelDeclarationV1, lift_package_model_declaration_v1,
};
pub use package_model_keywords_v1::{
    PACKAGE_MODEL_KEYWORDS_POLICY_V1, PackageModelKeywordsErrorV1, TypedPackageModelKeywordsV1,
    lift_package_model_keywords_v1,
};
pub use pin_declaration_v1::{
    PIN_DECLARATION_POLICY_V1, PinDeclarationErrorV1, TypedPinDeclarationV1,
    lift_pin_declarations_v1,
};
pub use pin_model_linkage_v1::{
    PIN_MODEL_LINKAGE_POLICY_V1, PinModelLinkageErrorV1, PinModelLinkageV1,
    resolve_pin_model_linkage_v1,
};
pub use ramp_package_spec_v1::{
    PackageSpecErrorV1, PackageSpecV1, RAMP_PACKAGE_SCOPE_POLICY_V1, RampSpecErrorV1, RampSpecV1,
};
pub use receiver_thresholds_keywords_v1::{
    RECEIVER_THRESHOLDS_KEYWORDS_POLICY_V1, ReceiverThresholdsKeywordsErrorV1,
    TypedReceiverThresholdsBlockV1, lift_receiver_thresholds_block_v1,
};
...
pub use series_pin_mapping_group_v1::{
    ...
    TypedSeriesPinGroupV1, lift_series_pin_group_v1,
};
pub use series_pin_mapping_keywords_v1::{
    SERIES_PIN_MAPPING_KEYWORDS_POLICY_V1, SeriesPinMappingKeywordsErrorV1,
    TypedSeriesPinMappingBlockV1, lift_series_pin_mapping_block_v1,
};
pub use series_pin_mapping_table_group_model_thresholds_v1::{
    SERIES_PIN_TABLE_GROUP_MODEL_THRESHOLDS_POLICY_V1, SeriesPinTableGroupModelThresholdsErrorV1,
    TypedSeriesPinGroupModelThresholdRecordV1, lift_series_pin_group_model_threshold_record_v1,
};
pub use series_pin_mapping_table_group_selector_v1::{
    SERIES_PIN_TABLE_GROUP_SELECTOR_POLICY_V1, SeriesPinTableGroupSelectorErrorV1,
    TypedSeriesPinGroupSelectorRecordV1, lift_series_pin_group_selector_record_v1,
};
pub use series_pin_mapping_table_group_switch_thresholds_v1::{
    SERIES_PIN_TABLE_GROUP_SWITCH_THRESHOLDS_POLICY_V1, SeriesPinTableGroupSwitchThresholdsErrorV1,
    TypedSeriesPinGroupSwitchThresholdRecordV1, lift_series_pin_group_switch_threshold_record_v1,
};
pub use series_pin_mapping_table_group_switch_v1::{
    SERIES_PIN_TABLE_GROUP_SWITCH_POLICY_V1, SeriesPinTableGroupSwitchErrorV1,
    TypedSeriesPinGroupSwitchRecordV1, lift_series_pin_group_switch_record_v1,
};
pub use series_pin_mapping_table_group_thresholds_v1::{
    SERIES_PIN_TABLE_GROUP_THRESHOLDS_POLICY_V1, SeriesPinTableGroupThresholdsErrorV1,
    TypedSeriesPinGroupThresholdRecordV1, lift_series_pin_group_threshold_record_v1,
};
pub use series_pin_mapping_table_group_v1::{
    SERIES_PIN_TABLE_GROUP_POLICY_V1, SeriesPinTableGroupModelErrorV1,
    TypedSeriesPinGroupModelRecordV1, lift_series_pin_group_model_record_v1,
};
...
pub use series_pin_mapping_table_selector_group_thresholds_v1::{
    ...
    SeriesPinTableSelectorGroupThresholdsErrorV1, TypedSeriesPinGroupSelectorThresholdRecordV1,
...
pub use series_pin_mapping_table_selector_thresholds_group_v1::{
    ...
    SeriesPinTableSelectorThresholdsGroupErrorV1, TypedSeriesPinSelectorGroupThresholdRecordV1,
    lift_series_pin_selector_group_threshold_record_v1,
};
pub use series_pin_mapping_table_selector_thresholds_v1::{
    SERIES_PIN_TABLE_SELECTOR_THRESHOLDS_POLICY_V1, SeriesPinTableSelectorThresholdsErrorV1,
    TypedSeriesPinSelectorThresholdRecordV1, lift_series_pin_selector_threshold_record_v1,
};
pub use series_pin_mapping_table_selector_v1::{
    SERIES_PIN_TABLE_SELECTOR_POLICY_V1, SeriesPinTableSelectorErrorV1,
    TypedSeriesPinSelectorRecordV1, lift_series_pin_selector_record_v1,
};
pub use series_pin_mapping_v1::{
    SERIES_PIN_MAPPING_TABLE_POLICY_V1, SeriesPinMappingTableErrorV1, TypedSeriesPinRecordV1,
    lift_series_pin_record_v1,
};
pub use series_pin_thresholds_group_v1::{
    SERIES_PIN_TABLE_THRESHOLDS_GROUP_POLICY_V1, SeriesPinTableThresholdsGroupErrorV1,
    TypedSeriesPinTableGroupThresholdsV1, lift_series_pin_table_group_thresholds_v1,
};
pub use series_pin_thresholds_v1::{
    SERIES_PIN_THRESHOLDS_POLICY_V1, SeriesPinThresholdsErrorV1, TypedSeriesPinThresholdsV1,
    lift_series_pin_thresholds_v1,
};
pub use series_switch_groups_keywords_v1::{
    SERIES_SWITCH_KEYWORDS_POLICY_V1, SeriesSwitchKeywordsErrorV1, TypedSeriesSwitchBlockV1,
    lift_series_switch_block_v1,
};
pub use series_switch_groups_v1::{
    SERIES_SWITCH_GROUPS_POLICY_V1, SeriesSwitchGroupsErrorV1, TypedSeriesSwitchGroupV1,
    lift_series_switch_group_v1,
};
pub use series_switch_mapping_v1::{
    SERIES_SWITCH_MAPPING_TABLE_POLICY_V1, SeriesSwitchMappingTableErrorV1,
    TypedSeriesSwitchRecordV1, lift_series_switch_record_v1,
};
pub use series_switch_thresholds_v1::{
    SERIES_SWITCH_THRESHOLDS_POLICY_V1, SeriesSwitchThresholdsErrorV1,
    TypedSeriesSwitchThresholdsV1, lift_series_switch_thresholds_v1,
};
pub use submodel_declaration_v1::{
    SUBMODEL_DECLARATION_POLICY_V1, SubmodelDeclarationErrorV1, SubmodelModeV1, SubmodelTypeV1,
    TypedAddSubmodelV1, TypedSubmodelDeclarationV1, lift_add_submodel_v1,
    lift_submodel_declaration_v1,
};
pub use test_data_declaration_v1::{
    TEST_DATA_DECLARATION_POLICY_V1, TestDataDeclarationErrorV1, TypedTestDataDeclarationV1,
    lift_test_data_declaration_v1,
};
