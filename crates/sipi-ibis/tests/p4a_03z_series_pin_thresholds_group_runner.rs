//! External-only typed series pin group threshold parameters cross-check runner (P4A-03z).
//!
//! Lifts one typed [Series Pin Mapping] group threshold declaration from input parameters
