//! External-only typed series pin table selector threshold parameters cross-check runner (P4A-03am).
//!
...
fn main() {
    ...
    let Some(input) = input else {
        println!("usage: p4a_03am_series_pin_table_selector_thresholds_runner --input <json> [--report <path>]");
        return;
    };
