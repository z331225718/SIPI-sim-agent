//! External-only typed series pin group model binding cross-check runner (P4A-03x).
//!
...
fn main() {
    ...
    let Some(input) = input else {
        println!("usage: p4a_03x_series_pin_table_group_runner --input <json> [--report <path>]");
        return;
    };
