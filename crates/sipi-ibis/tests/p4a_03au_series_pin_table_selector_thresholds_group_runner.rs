...
fn main() {
    ...
    let Some(input) = input else {
        println!(
            "usage: p4a_03au_series_pin_table_selector_thresholds_group_runner --input <json> [--report <path>]"
        );
        return;
    };
    ...
    let output = match lift_series_pin_selector_group_threshold_record_v1(
