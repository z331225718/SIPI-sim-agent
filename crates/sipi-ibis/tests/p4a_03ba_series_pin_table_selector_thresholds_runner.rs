//! External-only typed series pin Model Selector threshold table cross-check runner (P4A-03ba).
//!
...
fn main() {
    ...
    let Some(input) = input else {
        println!("usage: p4a_03ba_series_pin_table_selector_thresholds_runner --input <json> [--report <path>]");
        return;
    };
