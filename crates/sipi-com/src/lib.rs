...
mod workbook_v1;
pub use bathtub_v1::{
    bathtub_opening_width_v1, BathtubErrorV1, BathtubSampleV1, BATHTUB_POLICY_V1,
};
pub use bathtub_fit_v1::{
    fit_bathtub_curve_v1, BathtubCurveFitV1, BathtubFitErrorV1, BATHTUB_FIT_POLICY_V1,
    BATHTUB_FIT_MAX_ORDER,
};
pub use eye_contour_v1::{
    statistical_eye_contour_v1, EyeContourV1, EyeContourErrorV1, EyeGridV1,
    TimeColumnContourV1, EYE_CONTOUR_POLICY_V1,
};
pub use canonical_input_keys_v1::{
    canonical_input_keys_v1, CanonicalInputKeysErrorV1,
    CANONICAL_INPUT_KEYS_POLICY_V1,
};
pub use build_noise_pdf_v1::{build_r480_noise_pdf_v1, R480NoisePdfV1, BUILD_NOISE_PDF_POLICY_V1};
pub use c2m_eye_v1::{
    calculate_c2m_vertical_eye_v1, C2mEyeErrorV1, C2M_EYE_POLICY_V1,
};
pub use candidate_eval_v1::{
    c2m_candidate_fom_v1, evaluate_candidate_v1, CandidateEvalErrorV1, CandidateEvalOptionsV1,
    CandidateEvalParamsV1, NonMmseSearchResultV1, CANDIDATE_EVAL_POLICY_V1,
};
pub use candidate_helpers_v1::{
    ...
    DfeCandidateParamsV1, CANDIDATE_HELPERS_POLICY_V1,
};
pub use combined_noise_pdf_v1::{
    combine_r480_noise_pdf_v1, CombinedNoisePdfV1, COMBINED_NOISE_PDF_POLICY_V1,
};
pub use db_tolerance_v1::{
    db_tolerance_check_v1, owner_db_tolerance_check_v1, DbToleranceErrorV1, DbToleranceResultV1,
    DB_TOLERANCE_POLICY_V1, OWNER_DB_TOLERANCE_V1,
};
pub use dfe_v1::{
    apply_dfe_bank_v1, apply_tail_rss_bounds_v1, clip_dfe_v1, find_dfe_bank_locations_v1,
    DfeBankResultV1, DfeErrorV1, TailRssBoundsV1, DFE_POLICY_V1,
};
pub use discrete_pdf_v1::{
    convolve_v1, normal_pdf_v1, DiscretePdfV1, DISCRETE_PDF_POLICY_V1, PdfErrorV1,
};
pub use crosstalk_noise_v1::{
    crosstalk_noise_v1, td_source_crosstalk_noise_v1, XtalkChannelV1, XtalkErrorV1,
    XtalkParamsV1, CROSSTALK_NOISE_POLICY_V1,
};
pub use csv_reader_v1::{csv_value_v1, read_com_settings_csv_v1, CSV_READER_POLICY_V1};
pub use equalizer_frontend_v1::{
    cursor_sample_index_v1, fd_ctle_v1, td_ctle_v1, CursorSampleV1, EqualizerErrorV1,
    EQUALIZER_FRONTEND_POLICY_V1,
};
pub use erf_v1::{erf_v1, erfcinv_v1, erfinv_v1, ERF_POLICY_V1};
pub use qfactor_ber_v1::{
    ber_to_q_factor_v1, estimate_ber_v1, estimate_q_factor_v1, q_factor_to_ber_v1, QFactorBerErrorV1,
    OWNER_TOLERANCE_POLICY_V1, QFACTOR_BER_POLICY_V1,
};
pub use mat_reader_v1::{read_com_settings_mat_v1, MAT_READER_POLICY_V1};
pub use parameter_surface_v1::{
    classify_parameter_surface_v1, extract_parameter_pairs_v1, ParameterPairV1,
    ParameterSurfaceReportV1, PARAMETER_SURFACE_POLICY_V1,
};
pub use matlab_literal_v1::{parse_literal_v1, LiteralV1};
pub use value_consumption_v1::{
    resolve_default_value_v1, ConsumptionErrorV1, ResolvedDefaultV1, VALUE_CONSUMPTION_POLICY_V1,
};
pub use warning_report_v1::{
    aggregate_warning_report_v1, WarningCodeV1, WarningReportErrorV1,
    WarningReportV1, WarningSliceReportV1, WARNING_REPORT_POLICY_V1,
};
pub use warning_detector_v1::{
    anti_causal_precursor_fraction_v1, detect_anti_causal_v1, detect_high_freq_non_decay_v1,
    WarningDetectorErrorV1, WARNING_DETECTOR_POLICY_V1,
};
pub use workbook_v1::{
    read_com_settings_xlsx_v1, validate_xlsx_container_v1, is_strict_ooxml_v1,
    CellValueV1, ComSettingsV1, RawCellV1, WorkbookErrorV1, WORKBOOK_IMPORT_POLICY_V1,
};
pub use receiver_noise_v1::{
    bessel_thomson_filter_v1, butterworth_filter_v1, raised_cosine_filter_v1,
    receiver_noise_v1, rx_ffe_frequency_response_v1, tukey_window_v1, NoiseErrorV1,
    ReceiverNoiseOptionsV1, ReceiverNoiseParamsV1, RECEIVER_NOISE_POLICY_V1,
};
pub use rx_ffe_v1::{
    apply_rx_ffe_v1, force_floating_rx_ffe_v1, force_rx_ffe_v1, ForcedRxFfeResultV1,
    RxFfeErrorV1, FLOATING_RX_FFE_POLICY_V1, RX_FFE_POLICY_V1,
};
pub use resolve_parameters_v1::{
    resolve_default_set_v1, ResolveParametersErrorV1, RESOLVE_PARAMETERS_POLICY_V1,
};
pub use residual_channel_pdf_v1::{
    residual_channel_pdf_v1, ResidualPdfResultV1, RESIDUAL_CHANNEL_PDF_POLICY_V1,
};
pub use search_loop_v1::{
    peak_window, r480_sample_offsets, rectangular_pulse_response_v1,
    search_r480_nonmmse_no_xtalk_v1, shift_matrix, skip_high_pass_local_search, skip_local_search,
    anchored_cursor, validate_supported_branch, SearchFullOptionsV1, SearchFullParamsV1,
    SearchLoopErrorV1, SearchLoopOptionsV1, SearchLoopParamsV1, SearchLoopResultV1,
...
pub use search_support_v1::{
    ...
    system_noise_response_v1, CtleParamsV1, SearchErrorV1, SEARCH_SUPPORT_POLICY_V1,
};
pub use tx_ffe_v1::{
    build_txffe_grid_v1, first_strict_best_v1, full_grid_matrix_v1, select_fom_tracker_v1,
    select_strict_best_v1, CandidateSelectionV1, FomSelectionV1, TxFfeErrorV1, TxFfeGridV1,
    TX_FFE_POLICY_V1,
};
pub use sampled_signal_pdf_v1::{
    accelerated_sampled_signal_pdf_v1, from_values_v1, sampled_signal_pdf_v1,
    sparse_pam_component_v1, PAM4_SYMBOL_VALUES, SAMPLED_SIGNAL_PDF_POLICY_V1,
};
pub use compliance_report_v1::{
    compliance_report_v1, ComplianceErrorV1, ComplianceMetricSpecV1, ComplianceReportV1,
    MetricComplianceV1, COMPLIANCE_REPORT_POLICY_V1,
};
...
pub use com_parameters_v1::{
    merge_com_parameters_v1, ComParametersErrorV1, ComParametersV1, COM_PARAMETERS_POLICY_V1,
};
pub use com_chain_v1::{
    run_com_chain_v1, ComChainControlsV1, ComChainErrorV1, ComChainReportV1,
    COM_CHAIN_POLICY_V1,
};
pub use com_run_execution_v1::{
    execute_com_run_v1, ComRunExecutionErrorV1, ComRunResultEnvelopeV1,
    COM_RUN_EXECUTION_POLICY_V1, COM_RUN_RESULT_SCHEMA_V1,
};
pub use com_run_admission_v1::{
    com_run_admission_v1, ComRunAdmissionErrorV1, ComRunAdmissionV1,
    COM_RUN_ADMISSION_POLICY_V1, COM_RUN_REQUEST_SCHEMA_V1,
};
pub use com_metrics_v1::{
    calculate_com_metrics_v1, ComMetricsErrorV1, ComMetricsV1, COM_METRICS_POLICY_V1,
};
pub use horizontal_margin_v1::{
    compute_horizontal_margins_v1, margins_from_bathtub_v1, HorizontalMarginErrorV1,
    HorizontalMarginsV1, HORIZONTAL_MARGIN_POLICY_V1,
};
pub use ingest_v1::{
    apply_internal_port_order_v1, ingest_row_v1, FILE_TO_INTERNAL_ORDER_V1, INGEST_POLICY_V1,
    Sdd21SampleV1,
};
pub use mixed_mode_v1::{
    com_mixed_mode_v1, com_t_v1, sdd21_v1, FourPortSMatrixV1, NETWORK_INGEST_POLICY_V1,
};
...
mod tests {
    ...
    fn output_metrics_envelope_constructs() {
        let values: [ComMetricValueV1; 14] = std::array::from_fn(|_| ComMetricValueV1::try_new(Some(1.0)).expect("metric"));
    ...
    fn network_metric_validates_scalars() {
        ...
        assert!(ComNetworkMetricV1::try_new(
            "THRU".to_string(),
            "s4p".to_string(),
            0.0,
            -10.0,
    ...
    fn checkpoint_validates_taps_and_itick() {
        let checkpoint = ComCaseCheckpointV1::try_new(
            vec![2, 1, 0],
            vec![1],
            0.01,
            0.02,
