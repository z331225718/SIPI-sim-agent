...
use sipi_ami_text::{
    parameter_list_head_tail_v1, AmiParameterValueV1, ParameterListHeadTailErrorV1,
...
fn main() {
    ...
    let Some(input) = input else {
        println!("usage: p4b_02b117_parameter_list_head_tail_runner --input <path> [--report <path>]");
        return;
    };
