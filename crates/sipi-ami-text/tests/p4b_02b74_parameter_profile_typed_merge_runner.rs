...
use sipi_ami_text::{
    merge_parameter_profiles_typed_v1, AmiParameterValueV1, ParameterProfileTypedMergeErrorV1,
    PARAMETER_PROFILE_TYPED_MERGE_POLICY_V1,
};
...
fn main() {
    ...
    let Some(input) = input else {
        println!("usage: p4b_02b74_parameter_profile_typed_merge_runner --input <path> [--report <path>]");
        return;
    };
