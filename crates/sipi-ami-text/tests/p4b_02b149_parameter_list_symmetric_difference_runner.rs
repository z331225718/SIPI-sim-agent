...
use sipi_ami_text::{
    list_symmetric_difference_v1, AmiParameterValueV1, ParameterListSymmetricDifferenceErrorV1,
...
fn main() {
    ...
    let Some(input) = input else {
        println!("usage: p4b_02b149_parameter_list_symmetric_difference_runner --input <path> [--report <path>]");
        return;
    };
