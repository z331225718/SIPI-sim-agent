...
use sipi_ami_text::{
    merge_parameter_profiles_v1, AmiParameterValueV1, PARAMETER_PROFILE_MERGE_POLICY_V1,
};
...
fn main() {
    ...
    let Some(input) = input else {
        println!("usage: p4b_02b48_parameter_profile_merge_runner --input <path> [--report <path>]");
        return;
    };
