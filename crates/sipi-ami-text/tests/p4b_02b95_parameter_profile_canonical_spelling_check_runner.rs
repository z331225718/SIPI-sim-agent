...
use sipi_ami_text::{
    AmiParameterValueV1, PARAMETER_PROFILE_CANONICAL_SPELLING_CHECK_POLICY_V1,
    check_parameter_profile_spellings_canonical_v1,
};
...
pub(crate) fn main() {
    ...
    let Some(input) = input else {
        println!(
            "usage: p4b_02b95_parameter_profile_canonical_spelling_check_runner --input <path> [--report <path>]"
        );
        return;
    };
