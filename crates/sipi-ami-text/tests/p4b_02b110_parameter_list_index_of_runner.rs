...
use sipi_ami_text::{
    index_of_parameter_list_item_v1, AmiParameterValueV1, ParameterListIndexOfErrorV1,
...
fn main() {
    ...
    let Some(input) = input else {
        println!("usage: p4b_02b110_parameter_list_index_of_runner --input <path> [--report <path>]");
        return;
    };
