...
use sipi_ami_text::{
    AmiParameterValueV1, PARAMETER_LIST_IS_ALTERNATING_POLICY_V1,
    ParameterListIsAlternatingErrorV1, parameter_list_is_alternating_v1,
};
...
pub(crate) fn main() {
    ...
    let Some(input) = input else {
        println!(
            "usage: p4b_02b175_parameter_list_is_alternating_runner --input <path> [--report <path>]"
        );
        return;
    };
