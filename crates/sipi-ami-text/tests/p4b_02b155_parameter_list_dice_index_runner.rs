...
use sipi_ami_text::{
    AmiParameterValueV1, PARAMETER_LIST_DICE_INDEX_POLICY_V1, ParameterListDiceIndexErrorV1,
    list_dice_index_v1,
};
...
pub(crate) fn main() {
    ...
    let Some(input) = input else {
        println!(
            "usage: p4b_02b155_parameter_list_dice_index_runner --input <path> [--report <path>]"
        );
        return;
    };
