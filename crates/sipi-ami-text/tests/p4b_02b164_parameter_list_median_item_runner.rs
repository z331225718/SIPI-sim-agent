...
use sipi_ami_text::{
    AmiParameterValueV1, PARAMETER_LIST_MEDIAN_ITEM_POLICY_V1, ParameterListMedianItemErrorV1,
...
pub(crate) fn main() {
    ...
    let Some(input) = input else {
        println!(
            "usage: p4b_02b164_parameter_list_median_item_runner --input <path> [--report <path>]"
        );
        return;
    };
