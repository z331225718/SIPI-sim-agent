...
use sipi_ami_text::{
    AmiParameterValueV1, PARAMETER_PROFILE_SELECTION_POLICY_V1, select_parameter_profile_v1,
};
...
pub(crate) fn main() {
    ...
    let Some(input) = input else {
        println!(
            "usage: p4b_02b64_parameter_profile_select_runner --input <path> [--report <path>]"
        );
        return;
    };
