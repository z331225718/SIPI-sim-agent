...
use sipi_ami_text::{
    AmiParameterValueV1, PARAMETER_LIST_RUN_LENGTH_ENCODE_POLICY_V1,
    ParameterListRunLengthEncodeErrorV1, run_length_encode_parameter_list_v1,
};
...
pub(crate) fn main() {
    ...
    let Some(input) = input else {
        println!(
            "usage: p4b_02b119_parameter_list_run_length_encode_runner --input <path> [--report <path>]"
        );
        return;
    };
