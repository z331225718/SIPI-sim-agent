...
use sipi_ami_text::{
    AmiParameterTreeNodeV1, PARAMETER_TREE_LEAF_CANONICALIZATION_POLICY_V1, ParseLimitsV1,
...
pub(crate) fn main() {
    ...
    let Some(input) = input else {
        println!(
            "usage: p4b_02b78_parameter_tree_leaf_canonicalization_runner --input <path> [--report <path>]"
        );
        return;
    };
