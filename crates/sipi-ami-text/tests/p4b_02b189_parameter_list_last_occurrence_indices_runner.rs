...
use sipi_ami_text::{
    AmiParameterValueV1, PARAMETER_LIST_LAST_OCCURRENCE_INDICES_POLICY_V1,
    ParameterListLastOccurrenceIndicesErrorV1, parameter_list_last_occurrence_indices_v1,
};
...
pub(crate) fn main() {
    ...
    let Some(input) = input else {
        println!(
            "usage: p4b_02b189_parameter_list_last_occurrence_indices_runner --input <path> [--report <path>]"
        );
        return;
    };
