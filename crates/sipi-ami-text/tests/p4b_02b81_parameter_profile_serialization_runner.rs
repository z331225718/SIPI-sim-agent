...
use sipi_ami_text::{
    serialize_parameter_profile_v1, AmiParameterValueV1,
    PARAMETER_PROFILE_SERIALIZATION_POLICY_V1,
};
...
fn main() {
    ...
    let Some(input) = input else {
        println!("usage: p4b_02b81_parameter_profile_serialization_runner --input <path> [--report <path>]");
        return;
    };
