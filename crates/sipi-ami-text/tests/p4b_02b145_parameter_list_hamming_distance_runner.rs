...
use sipi_ami_text::{
    list_hamming_distance_v1, AmiParameterValueV1, ParameterListHammingDistanceErrorV1,
...
fn main() {
    ...
    let Some(input) = input else {
        println!("usage: p4b_02b145_parameter_list_hamming_distance_runner --input <path> [--report <path>]");
        return;
    };
