...
use sipi_ami_text::{
    parameter_list_entropy_v1, AmiParameterValueV1, ParameterListEntropyErrorV1,
...
fn main() {
    ...
    let Some(input) = input else {
        println!("usage: p4b_02b176_parameter_list_entropy_runner --input <path> [--report <path>]");
        return;
    };
