...
use sipi_ami_text::{
    AmiParameterValueV1, PARAMETER_LIST_ADJACENT_CHANGE_COUNT_POLICY_V1,
    ParameterListAdjacentChangeCountErrorV1, parameter_list_adjacent_change_count_v1,
};
...
pub(crate) fn main() {
    ...
    let Some(input) = input else {
        println!(
            "usage: p4b_02b172_parameter_list_adjacent_change_count_runner --input <path> [--report <path>]"
        );
        return;
    };
