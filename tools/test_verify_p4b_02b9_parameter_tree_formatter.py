# -*- coding: utf-8 -*-
"""Tests for the P4B-02b9 AMI parameter tree S-expression formatter verifier."""
...
import verify_p4b_02b9_parameter_tree_formatter as GATE


class ParameterTreeFormatterTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn format_parameter_trees_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b9", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterTreeFormatterError):
                    GATE.validate(ROOT)
