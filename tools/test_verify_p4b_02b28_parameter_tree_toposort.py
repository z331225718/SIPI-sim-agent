# -*- coding: utf-8 -*-
"""Tests for the P4B-02b28 AMI parameter tree path toposort verifier."""
...
import verify_p4b_02b28_parameter_tree_toposort as GATE


class ParameterTreeToposortTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn toposort_parameter_tree_paths_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b28", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterTreeToposortError):
                    GATE.validate(ROOT)
