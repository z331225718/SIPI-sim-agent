# -*- coding: utf-8 -*-
"""Fail closed on the P4A-03ar typed IBIS series pin group model binding core.
...
evidence, Rust tokens, PLAN P4A-03ar.
"""
...
CHARTER = ROOT / "docs" / "baselines" / "p4a-03ar-series-pin-table-group-stage.v1.yaml"
SOURCE_MAP = ROOT / "docs" / "baselines" / "p4a-03ar-mit-source-map.v1.yaml"
...
PLAN = ROOT / "PLAN.md"
SCHEMA = "sipi.p4a-03ar.series-pin-table-group-stage.v1"
...
def validate(root: Path = ROOT) -> dict[str, Any]:
    ...
    if evidence.get("schema") != "sipi.p4a-03ar.series-pin-table-group-crosscheck-evidence.v1":
