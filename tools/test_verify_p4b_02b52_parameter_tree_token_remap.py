# -*- coding: utf-8 -*-
"""Tests for the P4B-02b52 AMI parameter tree token remap verifier."""
...
import verify_p4b_02b52_parameter_tree_token_remap as GATE


class ParameterTreeTokenRemapTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn remap_parameter_tree_tokens_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b52", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterTreeTokenRemapError):
                    GATE.validate(ROOT)
