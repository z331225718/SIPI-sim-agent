# -*- coding: utf-8 -*-
"""Tests for the P4B-02b61 AMI text form heads counting verifier."""
...
import verify_p4b_02b61_ami_text_form_heads as GATE


class AmiTextFormHeadsTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn count_ami_text_form_heads_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b61", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.AmiTextFormHeadsError):
                    GATE.validate(ROOT)
