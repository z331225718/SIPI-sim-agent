...
def main():
    ...
    output={"schema":"sipi.p5-06.original13-extended-scalar-aggregate.v1","status":"accepted_stage1" if matlab_repeat and rust_repeat and cross else "blocked","formal_runs":formal_runs,"source":reports[0]["source"],"channels":reports[0]["channels"],"slot_count":len(maps[0]),"matlab_repeat_1e_12":matlab_repeat,"rust_repeat_exact":rust_repeat,"rust_vs_matlab_1e_9":cross,"stage2":{"status":"diagnostic_only","array_tolerances":"unset","instrumentation_equivalence":"unproven"},"claims":{"historical_python_used":False,"td_iln_required":False,"s_parameter_fit":False,"one_final_fd_to_td_impulse":True,"release":False}}
