"""AS-04 direct-port verifier entry point."""
from pathlib import Path
import sys
import yaml

ROOT = Path(__file__).resolve().parents[1]
EVIDENCE = ROOT / "docs/baselines/as-04-tune-yparam-tran-direct-port.v1.yaml"
AUDIT_PATH = ROOT / "docs/baselines/audits/2026-08-23-as-04-tune-yparam-tran-direct-port.md"
