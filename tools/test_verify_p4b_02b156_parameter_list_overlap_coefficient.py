# -*- coding: utf-8 -*-
"""Tests for the P4B-02b156 parameter list overlap coefficient verifier."""
...
import verify_p4b_02b156_parameter_list_overlap_coefficient as GATE


class ParameterListOverlapCoefficientTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn list_overlap_coefficient_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b156", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterListOverlapCoefficientError):
                    GATE.validate(ROOT)
