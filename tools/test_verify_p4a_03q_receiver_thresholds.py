# -*- coding: utf-8 -*-
"""Tests for the P4A-03q typed IBIS receiver thresholds verifier."""
...
import verify_p4a_03q_receiver_thresholds as GATE


class ReceiverThresholdsTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn lift_receiver_thresholds_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4A-03q", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ReceiverThresholdsError):
                    GATE.validate(ROOT)
