"""Verify the P3A-11 current-candidate CLI evidence record."""
...
from verify_channel_s2p_matched_external_compare_evidence_v2 import (
    EVIDENCE as CORE_EVIDENCE,
...
SCHEMA = "sipi.channel.s2p-matched.cli-current-external-compare-evidence.v2"
EVIDENCE = ROOT / "docs" / "baselines" / "channel-s2p-matched-cli-current-external-compare-evidence.v2.yaml"
...
def verify_document(document: object, report_path: Path | None = None) -> dict[str, object]:
    ...
    result = verify_historical_shape(
        ...
        core_evidence_verifier=verify_core_evidence,
