# -*- coding: utf-8 -*-
"""Tests for the P4B-02b37 AMI parameter tree leaf value decoding verifier."""
...
import verify_p4b_02b37_parameter_tree_leaf_value_decoding as GATE


class ParameterTreeLeafValueDecodingTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn decode_parameter_tree_leaf_values_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b37", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterTreeLeafValueDecodingError):
                    GATE.validate(ROOT)
