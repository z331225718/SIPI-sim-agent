# -*- coding: utf-8 -*-
"""Tests for the P3C-02h bathtub curve fit verifier."""
...
import verify_p3c_02h_bathtub_fit as GATE


class BathtubFitTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn fit_bathtub_curve_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P3C-02h", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.BathtubFitError):
                    GATE.validate(ROOT)
