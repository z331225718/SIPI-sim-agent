# -*- coding: utf-8 -*-
"""Tests for the P3C-03d dB-tolerance verifier."""
...
import verify_p3c_03d_db_tolerance as GATE


class DbTolTests(unittest.TestCase):
    ...
    def test_owner_tolerance_constant(self) -> None:
        source = GATE.SOURCE.read_text(encoding="utf-8")
        self.assertIn("pub const OWNER_DB_TOLERANCE_V1: f64 = 0.1;", source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P3C-03d", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_profile_admission(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "CHARTER", tmp_path):
                with self.assertRaises(GATE.DbTolError):
                    GATE.validate(ROOT)
