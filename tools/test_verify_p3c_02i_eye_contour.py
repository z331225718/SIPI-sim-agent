# -*- coding: utf-8 -*-
"""Tests for the P3C-02i statistical eye contour verifier."""
...
import verify_p3c_02i_eye_contour as GATE
...
class EyeContourTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn statistical_eye_contour_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P3C-02i", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.EyeContourError):
                    GATE.validate(ROOT)
