# -*- coding: utf-8 -*-
"""Tests for the P4B-02b41 AMI parameter tree inferred decoding verifier."""
...
import verify_p4b_02b41_parameter_tree_inferred_decode as GATE


class ParameterTreeInferredDecodingTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn decode_parameter_tree_with_inferred_types_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b41", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterTreeInferredDecodingError):
                    GATE.validate(ROOT)
