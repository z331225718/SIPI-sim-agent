# -*- coding: utf-8 -*-
"""Tests for the P4A-03at typed IBIS series pin group threshold parameters verifier."""
...
import verify_p4a_03at_series_pin_thresholds_group as GATE


class SeriesPinThresholdsGroupTests(unittest.TestCase):
    ...
    def test_plan_row_present(self) -> None:
        self.assertIn("**P4A-03at", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.SeriesPinThresholdsGroupError):
                    GATE.validate(ROOT)
