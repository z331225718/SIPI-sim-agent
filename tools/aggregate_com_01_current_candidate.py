...
def aggregate(
    ...
    *,
    ...
    aggregate_value = {
        ...
        "blockers": ["materialized_fingerprint_drift"],
        "matched": False,
        "acceptance": False,
        "non_claims": [
