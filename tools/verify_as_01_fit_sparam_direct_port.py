...
DEFAULT_MANIFEST = ROOT / "docs" / "baselines" / "as-01-fit-sparam-direct-port.v1.yaml"
...
CANDIDATE_HASHES = {
    "module_sha256": (
        ...
        "7c225577d9be42c444b11a9a0e3340653deb2ed23c9103458e1600ed1ccf6e21",
    ),
    "test_sha256": (
        "crates/sipi-agent-spice-direct/tests/as01.rs",
        "d69d2c64425ce2d86137127e855fa9d237aacb7d1304969f455abd2e9e07a3ac",
    ),
    "cli_sha256": (
    ...
    "cargo_toml_sha256": (
        ...
        "95aa070c15663f5e79984f5c1f35236b9a1306fc47258418f38db9adb76321ca",
    ),
    "cargo_lock_sha256": (
        "crates/sipi-agent-spice-direct/Cargo.lock",
        "7d1acce2bffd2ed3fcbf0ddb793fa1410123d1cbde7a7778a11bca43e78fe342",
    ),
}
...
def verify(
    ...
    *,
    ...
    require(
        document.get("schema") == "sipi.agent-spice-as-01-direct-port.v1",
        "schema drift",
    )
    require(document.get("status") == "minimal_numeric_candidate_open", "status overclaim or drift")
    ...
    require(
        source_text.index("ensure_artifact_boundaries(&plan.touchstone, &artifacts)?")
        < source_text.index("write_fit_artifacts(&FitArtifactContext"),
