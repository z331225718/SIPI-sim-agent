# -*- coding: utf-8 -*-
"""Tests for the P4B-02b46 AMI parameter tree expected-value check verifier."""
...
import verify_p4b_02b46_parameter_tree_expected_check as GATE


class ParameterTreeExpectedCheckTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn check_parameter_tree_against_expected_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b46", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterTreeExpectedCheckError):
                    GATE.validate(ROOT)
