"""Aggregate two R2024b and two Rust P5-06s v4 full matrix reports."""
...
try:
    ...
    from .run_p5_06_original13_fresh_matrix_v4 import METRICS, file_identity
    from .verify_p5_06_original13_fresh_matrix_v4 import verify
except ImportError:
    from run_p5_06_original13_fresh_matrix import digest
    from run_p5_06_original13_fresh_matrix_v4 import METRICS, file_identity
    from verify_p5_06_original13_fresh_matrix_v4 import verify
...
def main() -> int:
    ...
    aggregate = {
        "schema": "sipi.p5-06.original13-fresh-aggregate.v4",
        ...
        "gate_tools": {"aggregate": file_identity(Path(__file__)), "verifier": file_identity(Path(__file__).with_name("verify_p5_06_original13_fresh_matrix_v4.py"))},
