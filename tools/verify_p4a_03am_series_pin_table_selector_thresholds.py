# -*- coding: utf-8 -*-
"""Fail closed on the P4A-03am typed IBIS series pin table selector threshold parameters core.

Charter fixes the series pin table selector thresholds scope; cross-check evidence binds product
lifting against an independent reference. Verifier binds charter, source map,
evidence, Rust tokens, PLAN P4A-03am.
"""
...
CHARTER = ROOT / "docs" / "baselines" / "p4a-03am-series-pin-table-selector-thresholds-stage.v1.yaml"
SOURCE_MAP = ROOT / "docs" / "baselines" / "p4a-03am-mit-source-map.v1.yaml"
...
PLAN = ROOT / "PLAN.md"
SCHEMA = "sipi.p4a-03am.series-pin-table-selector-thresholds-stage.v1"
...
def validate(root: Path = ROOT) -> dict[str, Any]:
    ...
    if evidence.get("schema") != "sipi.p4a-03am.series-pin-table-selector-thresholds-crosscheck-evidence.v1":
