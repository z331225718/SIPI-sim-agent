# -*- coding: utf-8 -*-
"""Tests for the P4B-02b27 AMI parameter tree node replace verifier."""
...
import verify_p4b_02b27_parameter_tree_replace as GATE


class ParameterTreeReplaceTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn replace_parameter_tree_node_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b27", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterTreeReplaceError):
                    GATE.validate(ROOT)
