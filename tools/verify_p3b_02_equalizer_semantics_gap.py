...
RECORD = ROOT / "docs/baselines/p3b-02-equalizer-semantics-gap.v1.yaml"
SCHEMA = "sipi.p3b-02.equalizer-semantics-gap.v1"
...
def validate_document(document: dict[str, Any]) -> dict[str, Any]:
    ...
    if document["status"] != "blocked_missing_stage_semantics":
    ...
    if document["decision"] != {
        ...
        "implementation_status": "gap_evidence_only_no_product_equalizer_api",
        "reason": [
            ...
            "adding a non-bypass stage without the missing semantics would invent a product capability",
        ],
    }:
