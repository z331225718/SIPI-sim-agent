# -*- coding: utf-8 -*-
"""Tests for the P4B-02b63 parameter tree distinct leaf names verifier."""
...
import verify_p4b_02b63_parameter_tree_distinct_leaf_names as GATE


class ParameterTreeDistinctLeafNamesTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn list_parameter_tree_distinct_leaf_names_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b63", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterTreeDistinctLeafNamesError):
                    GATE.validate(ROOT)
