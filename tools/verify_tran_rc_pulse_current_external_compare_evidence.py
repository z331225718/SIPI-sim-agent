"""Verify current-candidate external evidence for the fixed TRAN profile.

The historical v1 attestation remains immutable. This verifier applies the
same strict report and source-tree checks to a newly observed product candidate.
"""
...
SCHEMA = "sipi.tran.rc-pulse.current-external-compare-evidence.v1"
EVIDENCE = ROOT / "docs" / "baselines" / "tran-rc-pulse-current-external-compare-evidence.v1.yaml"
