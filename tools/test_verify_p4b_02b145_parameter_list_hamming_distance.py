# -*- coding: utf-8 -*-
"""Tests for the P4B-02b145 parameter list Hamming distance verifier."""
...
import verify_p4b_02b145_parameter_list_hamming_distance as GATE


class ParameterListHammingDistanceTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn list_hamming_distance_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b145", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterListHammingDistanceError):
                    GATE.validate(ROOT)
