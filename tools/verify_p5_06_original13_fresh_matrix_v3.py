"""Strict verifier for one current P5-06s original-13 v3 replay."""
...
def verify(report: object) -> bool:
    ...
    expected = {
        ...
        "total_execution_wall_ns", "host_fingerprint", "selection_count", "source", "channels", "records", "claims",
    }
    ...
    require(report["run_id"] == f"original13-v3-{report['engine']}-{report['nonce']}", "run id")
