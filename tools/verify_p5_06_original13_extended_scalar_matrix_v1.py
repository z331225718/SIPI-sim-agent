...
try: from .run_p5_06_original13_extended_scalar_matrix_v1 import ADAPTER, CANDIDATE, CHANNELS, CONFIG_PATHS, METRICS, PROJECTION_SOURCES, UPSTREAM
except ImportError: from run_p5_06_original13_extended_scalar_matrix_v1 import ADAPTER, CANDIDATE, CHANNELS, CONFIG_PATHS, METRICS, PROJECTION_SOURCES, UPSTREAM
