# -*- coding: utf-8 -*-
"""Tests for the P4B-02b107 parameter list distinct count verifier."""
...
import verify_p4b_02b107_parameter_list_distinct_count as GATE


class ParameterListDistinctCountTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn count_distinct_parameter_list_items_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b107", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterListDistinctCountError):
                    GATE.validate(ROOT)
