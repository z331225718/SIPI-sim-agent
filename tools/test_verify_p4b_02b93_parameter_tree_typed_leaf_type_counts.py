# -*- coding: utf-8 -*-
"""Tests for the P4B-02b93 parameter tree typed-leaf type counts verifier."""
...
import verify_p4b_02b93_parameter_tree_typed_leaf_type_counts as GATE


class ParameterTreeTypedLeafTypeCountsTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn count_parameter_tree_typed_leaves_by_type_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b93", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterTreeTypedLeafTypeCountsError):
                    GATE.validate(ROOT)
