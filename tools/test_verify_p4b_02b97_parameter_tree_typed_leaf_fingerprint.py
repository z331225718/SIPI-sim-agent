# -*- coding: utf-8 -*-
"""Tests for the P4B-02b97 parameter tree typed-leaf fingerprint verifier."""
...
import verify_p4b_02b97_parameter_tree_typed_leaf_fingerprint as GATE


class ParameterTreeTypedLeafFingerprintTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn fingerprint_parameter_tree_typed_leaves_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b97", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterTreeTypedLeafFingerprintError):
                    GATE.validate(ROOT)
