# -*- coding: utf-8 -*-
"""Tests for the P4B-02b72 parameter profile tree coverage verifier."""
...
import verify_p4b_02b72_parameter_profile_tree_coverage as GATE


class ParameterProfileTreeCoverageTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn check_parameter_profile_tree_coverage_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b72", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterProfileTreeCoverageError):
                    GATE.validate(ROOT)
