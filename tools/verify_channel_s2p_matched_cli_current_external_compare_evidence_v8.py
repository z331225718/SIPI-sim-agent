"""Verify the P3A current-candidate CLI evidence record v8."""
...
SCHEMA = "sipi.channel.s2p-matched.cli-current-external-compare-evidence.v8"
EVIDENCE = ROOT / "docs" / "baselines" / "channel-s2p-matched-cli-current-external-compare-evidence.v8.yaml"
