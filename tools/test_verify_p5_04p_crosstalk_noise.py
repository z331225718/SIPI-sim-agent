"""Tests for the P5-04p crosstalk noise stage verifier."""
...
import verify_p5_04p_crosstalk_noise as GATE


class CrosstalkStageTests(unittest.TestCase):
    ...
    def test_source_map_has_three_mappings(self) -> None:
        ...
        self.assertIn("_evaluate_candidate / search loop", source_map["not_ported"])
    ...
    def test_plan_row_present(self) -> None:
        self.assertIn("**P5-04p", GATE.PLAN.read_text(encoding="utf-8"))

    def test_evidence_five_cases(self) -> None:
    ...
    def test_rejects_evaluation_admission(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "CHARTER", tmp_path):
                with self.assertRaises(GATE.CrosstalkStageError):
                    GATE.validate(ROOT)
