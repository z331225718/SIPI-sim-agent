# -*- coding: utf-8 -*-
"""Tests for the P4B-02b119 parameter list run-length encoding verifier."""
...
import verify_p4b_02b119_parameter_list_run_length_encode as GATE


class ParameterListRunLengthEncodeTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn run_length_encode_parameter_list_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b119", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterListRunLengthEncodeError):
                    GATE.validate(ROOT)
