# -*- coding: utf-8 -*-
"""Tests for the P4A-03i typed IBIS model selector & series pin mapping verifier."""
...
import verify_p4a_03i_model_selector as GATE
...
class ModelSelectorTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn lift_model_selector_declaration_v1", source)
        self.assertIn("pub fn lift_series_pin_mapping_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4A-03i", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ModelSelectorError):
                    GATE.validate(ROOT)
