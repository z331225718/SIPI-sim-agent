# -*- coding: utf-8 -*-
"""Tests for the P4B-02b112 parameter list remove-all-by-value verifier."""
...
import verify_p4b_02b112_parameter_list_remove_all as GATE


class ParameterListRemoveAllTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn remove_all_parameter_list_items_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b112", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterListRemoveAllError):
                    GATE.validate(ROOT)
