# -*- coding: utf-8 -*-
"""Tests for the P4B-02b40 AMI parameter tree leaf search verifier."""
...
import verify_p4b_02b40_parameter_tree_leaf_search as GATE


class ParameterTreeLeafSearchTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn find_parameter_tree_leaves_by_token_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b40", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterTreeSearchError):
                    GATE.validate(ROOT)
