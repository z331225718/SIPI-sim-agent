...
def verify(document: object) -> dict[str, object]:
    ...
    false = {"ads_or_product_raw_axis_bound", "product_raw_dtft_invoked", "ads_original_spectrum_product_raw_delta_observed", "ads_algorithm_reproduced", "causality_or_interpolation_cause_identified", "raw_periodic_response_admitted_as_causal_fir", "candidate_waveform_accepted", "release_ledger_promoted"}
