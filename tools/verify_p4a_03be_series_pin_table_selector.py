# -*- coding: utf-8 -*-
"""Fail closed on the P4A-03be typed IBIS series pin Model Selector binding core.
...
evidence, Rust tokens, PLAN P4A-03be.
"""
...
CHARTER = ROOT / "docs" / "baselines" / "p4a-03be-series-pin-table-selector-stage.v1.yaml"
SOURCE_MAP = ROOT / "docs" / "baselines" / "p4a-03be-mit-source-map.v1.yaml"
EVIDENCE = ROOT / "docs" / "baselines" / "p4a-03be-series-pin-table-selector-crosscheck-evidence.v1.yaml"
SOURCE = ROOT / "crates" / "sipi-ibis" / "src" / "series_pin_mapping_table_selector_binding_entry_v1.rs"
PLAN = ROOT / "PLAN.md"
SCHEMA = "sipi.p4a-03be.series-pin-table-selector-stage.v1"
...
def validate(root: Path = ROOT) -> dict[str, Any]:
    ...
    if evidence.get("schema") != "sipi.p4a-03be.series-pin-table-selector-crosscheck-evidence.v1":
