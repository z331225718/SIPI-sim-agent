# -*- coding: utf-8 -*-
"""Tests for the P4B-02b140 parameter list multi-value remove-all verifier."""
...
import verify_p4b_02b140_parameter_list_multi_remove_all as GATE


class ParameterListMultiRemoveAllTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn remove_all_parameter_list_items_multi_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b140", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterListMultiRemoveAllError):
                    GATE.validate(ROOT)
