# -*- coding: utf-8 -*-
"""Tests for the P4B-02b121 parameter list frequency map verifier."""
...
import verify_p4b_02b121_parameter_list_frequency as GATE


class ParameterListFrequencyTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn parameter_list_item_frequencies_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b121", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterListFrequencyError):
                    GATE.validate(ROOT)
