# -*- coding: utf-8 -*-
"""Fail closed on the P4A-03bb typed IBIS series pin group switch core.
...
evidence, Rust tokens, PLAN P4A-03bb.
"""
...
CHARTER = ROOT / "docs" / "baselines" / "p4a-03bb-series-pin-table-group-switch-stage.v1.yaml"
SOURCE_MAP = ROOT / "docs" / "baselines" / "p4a-03bb-mit-source-map.v1.yaml"
...
PLAN = ROOT / "PLAN.md"
SCHEMA = "sipi.p4a-03bb.series-pin-table-group-switch-stage.v1"
...
def validate(root: Path = ROOT) -> dict[str, Any]:
    ...
    if evidence.get("schema") != "sipi.p4a-03bb.series-pin-table-group-switch-crosscheck-evidence.v1":
