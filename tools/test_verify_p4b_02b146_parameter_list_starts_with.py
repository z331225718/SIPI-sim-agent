# -*- coding: utf-8 -*-
"""Tests for the P4B-02b146 parameter list starts-with verifier."""
...
import verify_p4b_02b146_parameter_list_starts_with as GATE


class ParameterListStartsWithTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn list_starts_with_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b146", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterListStartsWithError):
                    GATE.validate(ROOT)
