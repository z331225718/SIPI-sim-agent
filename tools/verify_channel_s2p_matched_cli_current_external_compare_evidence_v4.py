"""Verify the P3A-14 current-candidate CLI evidence record."""
...
SCHEMA = "sipi.channel.s2p-matched.cli-current-external-compare-evidence.v4"
EVIDENCE = ROOT / "docs" / "baselines" / "channel-s2p-matched-cli-current-external-compare-evidence.v4.yaml"
