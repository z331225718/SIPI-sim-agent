# -*- coding: utf-8 -*-
"""Tests for the P4B-02b120 parameter list longest-run verifier."""
...
import verify_p4b_02b120_parameter_list_longest_run as GATE


class ParameterListLongestRunTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn longest_run_parameter_list_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b120", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterListLongestRunError):
                    GATE.validate(ROOT)
