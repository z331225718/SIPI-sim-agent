# -*- coding: utf-8 -*-
"""Tests for the P4B-02b67 parameter tree longest common prefix verifier."""
...
import verify_p4b_02b67_parameter_tree_longest_common_prefix as GATE


class ParameterTreeLcpTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn longest_common_path_prefix_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b67", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterTreeLcpError):
                    GATE.validate(ROOT)
