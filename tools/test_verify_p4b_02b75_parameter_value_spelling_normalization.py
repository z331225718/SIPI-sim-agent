# -*- coding: utf-8 -*-
"""Tests for the P4B-02b75 parameter value spelling normalization verifier."""
...
import verify_p4b_02b75_parameter_value_spelling_normalization as GATE


class ParameterValueSpellingNormalizationTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn canonicalize_parameter_value_spelling_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b75", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterValueSpellingNormalizationError):
                    GATE.validate(ROOT)
