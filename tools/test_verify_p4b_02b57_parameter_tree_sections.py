# -*- coding: utf-8 -*-
"""Tests for the P4B-02b57 parameter tree sections listing verifier."""
...
import verify_p4b_02b57_parameter_tree_sections as GATE


class ParameterTreeSectionsTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn list_parameter_tree_sections_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b57", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterTreeSectionsError):
                    GATE.validate(ROOT)
