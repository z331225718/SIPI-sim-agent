"""AS-06 direct-port verifier entry point."""
from pathlib import Path
import sys
import yaml

ROOT = Path(__file__).resolve().parents[1]
EVIDENCE = ROOT / "docs/baselines/as-06-run-rfm-direct-port.v1.yaml"
AUDIT_PATH = ROOT / "docs/baselines/audits/2026-08-23-as-06-run-rfm-direct-port.md"
