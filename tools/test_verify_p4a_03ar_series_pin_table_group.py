# -*- coding: utf-8 -*-
"""Tests for the P4A-03ar typed IBIS series pin group model binding verifier."""
...
import verify_p4a_03ar_series_pin_table_group as GATE


class SeriesPinTableGroupTests(unittest.TestCase):
    ...
    def test_plan_row_present(self) -> None:
        self.assertIn("**P4A-03ar", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.SeriesPinTableGroupError):
                    GATE.validate(ROOT)
