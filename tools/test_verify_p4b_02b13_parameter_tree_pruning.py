# -*- coding: utf-8 -*-
"""Tests for the P4B-02b13 AMI parameter tree structural pruning verifier."""
...
import verify_p4b_02b13_parameter_tree_pruning as GATE


class ParameterTreePruningTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn prune_parameter_tree_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b13", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterTreePruningError):
                    GATE.validate(ROOT)
