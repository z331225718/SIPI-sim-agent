# -*- coding: utf-8 -*-
"""Tests for the P4B-02b89 parameter tree leaf typed diff verifier."""
...
import verify_p4b_02b89_parameter_tree_leaf_typed_diff as GATE


class ParameterTreeLeafTypedDiffTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn diff_parameter_tree_leaves_typed_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b89", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterTreeLeafTypedDiffError):
                    GATE.validate(ROOT)
