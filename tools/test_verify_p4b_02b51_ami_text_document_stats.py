# -*- coding: utf-8 -*-
"""Tests for the P4B-02b51 AMI text document statistics verifier."""
...
import verify_p4b_02b51_ami_text_document_stats as GATE


class AmiTextDocumentStatsTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn compute_ami_text_document_stats_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b51", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.AmiTextStatsError):
                    GATE.validate(ROOT)
