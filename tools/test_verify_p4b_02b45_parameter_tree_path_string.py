# -*- coding: utf-8 -*-
"""Tests for the P4B-02b45 AMI parameter tree path-string parsing verifier."""
...
import verify_p4b_02b45_parameter_tree_path_string as GATE


class ParameterTreePathStringTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn parse_parameter_tree_path_string_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b45", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterTreePathParseError):
                    GATE.validate(ROOT)
