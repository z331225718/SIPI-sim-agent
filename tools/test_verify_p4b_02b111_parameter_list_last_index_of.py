# -*- coding: utf-8 -*-
"""Tests for the P4B-02b111 parameter list item last-index-of verifier."""
...
import verify_p4b_02b111_parameter_list_last_index_of as GATE


class ParameterListLastIndexOfTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn last_index_of_parameter_list_item_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b111", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterListLastIndexOfError):
                    GATE.validate(ROOT)
