# -*- coding: utf-8 -*-
"""Tests for the P4B-02b14 AMI parameter tree structural visitor verifier."""
...
import verify_p4b_02b14_parameter_tree_visitor as GATE


class ParameterTreeVisitorTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn traverse_parameter_trees_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b14", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterTreeVisitorError):
                    GATE.validate(ROOT)
