# -*- coding: utf-8 -*-
"""Tests for the P4B-02b59 parameter tree leaf occurrence counts verifier."""
...
import verify_p4b_02b59_parameter_tree_leaf_occurrences as GATE


class ParameterTreeLeafOccurrencesTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn count_parameter_tree_leaf_occurrences_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b59", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterTreeLeafOccurrencesError):
                    GATE.validate(ROOT)
