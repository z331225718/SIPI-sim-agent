# -*- coding: utf-8 -*-
"""Tests for the P4A-03x typed IBIS series pin group model binding verifier."""
...
import verify_p4a_03x_series_pin_table_group as GATE


class SeriesPinTableGroupModelTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn lift_series_pin_group_model_record_v1", source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4A-03x", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.SeriesPinTableGroupModelError):
                    GATE.validate(ROOT)
