# -*- coding: utf-8 -*-
"""Tests for the P4B-02b132 parameter list interleave verifier."""
...
import verify_p4b_02b132_parameter_list_interleave as GATE


class ParameterListInterleaveTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn interleave_parameter_list_values_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b132", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterListInterleaveError):
                    GATE.validate(ROOT)
