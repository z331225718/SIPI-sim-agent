"""Tests for the P5-04c COM metrics stage verifier."""
...
import verify_p5_04c_com_metrics_stage as GATE
...
class MetricsTests(unittest.TestCase):
    ...
    def test_source_map_has_three_mappings(self) -> None:
        ...
        self.assertIn("DiscretePdf construction", source_map["not_ported"])
    ...
    def test_plan_row_present(self) -> None:
        ...
        self.assertIn("**P5-04c", plan_text)

    def test_rejects_pdf_admission(self) -> None:
        import copy
        import tempfile
        import unittest.mock as mock
        charter = copy.deepcopy(GATE.load_yaml(GATE.CHARTER))
        charter["admission"]["discrete_pdf_construction"] = True
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "CHARTER", tmp_path):
                with self.assertRaises(GATE.MetricsError):
                    GATE.validate(ROOT)
