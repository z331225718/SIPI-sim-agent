# -*- coding: utf-8 -*-
"""Tests for the P4B-02b76 typed parameter profile override merge verifier."""
...
import verify_p4b_02b76_parameter_profile_override_merge as GATE


class ParameterProfileOverrideMergeTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn merge_parameter_profiles_with_override_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b76", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterProfileOverrideMergeError):
                    GATE.validate(ROOT)
