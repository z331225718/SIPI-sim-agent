"""Verify the P3A-12 current-candidate CLI evidence record."""
...
SCHEMA = "sipi.channel.s2p-matched.cli-current-external-compare-evidence.v3"
EVIDENCE = ROOT / "docs" / "baselines" / "channel-s2p-matched-cli-current-external-compare-evidence.v3.yaml"
