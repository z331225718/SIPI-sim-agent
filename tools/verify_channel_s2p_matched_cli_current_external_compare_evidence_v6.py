"""Verify the P3A current-candidate CLI evidence record v6."""
...
SCHEMA = "sipi.channel.s2p-matched.cli-current-external-compare-evidence.v6"
EVIDENCE = ROOT / "docs" / "baselines" / "channel-s2p-matched-cli-current-external-compare-evidence.v6.yaml"
