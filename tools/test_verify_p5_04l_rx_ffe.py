"""Tests for the P5-04l RX FFE stage verifier."""
...
import verify_p5_04l_rx_ffe as GATE


class RxFfeStageTests(unittest.TestCase):
    ...
    def test_source_map_has_four_mappings(self) -> None:
        ...
        self.assertIn("force_floating_rx_ffe (floating RxFFE bank branch)", source_map["not_ported"])
    ...
    def test_plan_row_present(self) -> None:
        self.assertIn("**P5-04l", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_floating_admission(self) -> None:
        import copy
        import tempfile
        import unittest.mock as mock
        charter = copy.deepcopy(GATE.load_yaml(GATE.CHARTER))
        charter["admission"]["floating_rxffe"] = True
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "CHARTER", tmp_path):
                with self.assertRaises(GATE.RxFfeStageError):
                    GATE.validate(ROOT)
