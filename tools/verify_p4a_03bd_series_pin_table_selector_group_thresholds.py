# -*- coding: utf-8 -*-
"""Fail closed on the P4A-03bd typed IBIS series pin group Model Selector threshold parameters core.
...
evidence, Rust tokens, PLAN P4A-03bd.
"""
...
CHARTER = ROOT / "docs" / "baselines" / "p4a-03bd-series-pin-table-selector-group-thresholds-stage.v1.yaml"
SOURCE_MAP = ROOT / "docs" / "baselines" / "p4a-03bd-mit-source-map.v1.yaml"
...
PLAN = ROOT / "PLAN.md"
SCHEMA = "sipi.p4a-03bd.series-pin-table-selector-group-thresholds-stage.v1"
...
def validate(root: Path = ROOT) -> dict[str, Any]:
    ...
    if evidence.get("schema") != "sipi.p4a-03bd.series-pin-table-selector-group-thresholds-crosscheck-evidence.v1":
