# -*- coding: utf-8 -*-
"""Tests for the P4B-02b22 AMI parameter tree structural diff textual summary report verifier."""
...
import verify_p4b_02b22_parameter_tree_diff_summary as GATE


class ParameterTreeDiffSummaryTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn generate_parameter_tree_diff_summary_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b22", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterTreeDiffSummaryError):
                    GATE.validate(ROOT)
