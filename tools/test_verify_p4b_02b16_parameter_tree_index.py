# -*- coding: utf-8 -*-
"""Tests for the P4B-02b16 AMI parameter tree fast leaf path index verifier."""
...
import verify_p4b_02b16_parameter_tree_index as GATE


class ParameterTreeIndexTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn build_parameter_tree_index_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b16", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterTreeIndexError):
                    GATE.validate(ROOT)
