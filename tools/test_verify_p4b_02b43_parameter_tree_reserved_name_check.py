# -*- coding: utf-8 -*-
"""Tests for the P4B-02b43 AMI parameter tree reserved-name check verifier."""
...
import verify_p4b_02b43_parameter_tree_reserved_name_check as GATE


class ParameterTreeReservedNameCheckTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn check_parameter_tree_reserved_names_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b43", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterTreeReservedNameError):
                    GATE.validate(ROOT)
