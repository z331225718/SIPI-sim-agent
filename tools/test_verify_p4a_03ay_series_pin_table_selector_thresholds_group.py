# -*- coding: utf-8 -*-
"""Tests for the P4A-03ay typed IBIS series pin Model Selector group threshold parameters verifier."""
...
import verify_p4a_03ay_series_pin_table_selector_thresholds_group as GATE


class SeriesPinTableSelectorThresholdsGroupTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn lift_series_pin_selector_group_threshold_record_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4A-03ay", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.SeriesPinTableSelectorThresholdsGroupError):
                    GATE.validate(ROOT)
