...
EVIDENCE = ROOT / "docs/baselines/pb-01-legacy-leaf.v2.yaml"
...
def verify(
    ...
    _check(blockers, document.get("schema") == "sipi.pb-01-legacy-leaf.v2", "schema drift")
    _check(
        blockers,
        document.get("status") == "implemented_current_leaf_pending_immutable_bound_replay",
        "status drift",
    )
    ...
    _check(
        ...
        == {
            ...
            "predecessor_role": "historical_scoped_leaf_record",
            "supersedes": "none_historical_claim",
            "preserves_predecessor_open_branch_inventory": True,
            "successor_evidence": "docs/baselines/pb-01-portable-branch-coverage.v1.yaml",
        },
    ...
    if isinstance(audit, dict):
        ...
        _check(blockers, path == "docs/baselines/audits/2026-08-23-pb-01-legacy-leaf-runtime-v2.md", "audit path drift")
