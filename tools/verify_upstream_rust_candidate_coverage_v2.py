...
EVIDENCE = ROOT / "docs/baselines/upstream-rust-candidate-coverage.v2.yaml"
INVENTORY = ROOT / "docs/baselines/upstream-migration-inventory.v1.yaml"

SCHEMA = "sipi.upstream-rust-candidate-coverage.v2"
EXPECTED_ROWS = {
...
def _verify_audit_binding(root: Path, document: dict[str, Any]) -> None:
    ...
    _require(audit.get("path") == "docs/baselines/audits/2026-08-23-upstream-rust-candidate-coverage-v2.md", "audit_path_drift")
...
def validate(document: dict[str, Any] | None = None, root: Path = ROOT, source_roots: dict[str, Path] | None = None) -> dict[str, Any]:
    ...
    _require(document.get("relationship") == {
        "predecessor_evidence": "docs/baselines/upstream-rust-candidate-coverage.v1.yaml",
        "predecessor_verifier": "tools/verify_upstream_rust_candidate_coverage.py",
        "predecessor_retained": True,
        "successor_reason": "current_candidate_surface_source_rebind",
