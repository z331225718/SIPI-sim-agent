# -*- coding: utf-8 -*-
"""Tests for the P4B-02b44 AMI parameter profile assembly verifier."""
...
import verify_p4b_02b44_parameter_profile_assembly as GATE


class ParameterProfileAssemblyTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn assemble_parameter_profile_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b44", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterProfileAssemblyError):
                    GATE.validate(ROOT)
