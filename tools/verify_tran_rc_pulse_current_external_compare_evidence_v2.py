"""Verify the P2-06c current-candidate fixed TRAN evidence record."""
...
SCHEMA = "sipi.tran.rc-pulse.current-external-compare-evidence.v2"
EVIDENCE = ROOT / "docs" / "baselines" / "tran-rc-pulse-current-external-compare-evidence.v2.yaml"
