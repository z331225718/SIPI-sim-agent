"""Verify the P3A current-candidate CLI evidence record v7."""
...
SCHEMA = "sipi.channel.s2p-matched.cli-current-external-compare-evidence.v7"
EVIDENCE = ROOT / "docs" / "baselines" / "channel-s2p-matched-cli-current-external-compare-evidence.v7.yaml"
