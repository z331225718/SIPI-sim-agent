...
def expected() -> dict[str, object]:
    return {
        ...
        "independent_audit": {"reviewer": "Orca_OMP_user_authorized_terminal", "terminal": "term_fa7831f5-ec22-4b3d-8737-25a919226b8b", "status": "completed", "result": "no_high_or_critical_findings", "report": None},
