...
def backend_result(request):
    return {"schema": "sipi.backend-execution-result.v1", "run_id": request["run_id"], "analysis_id": request["analysis_id"], "attempt_id": request["attempt_id"], "backend_execution_id": request["backend_execution_id"], "role": request["role"], "engine_instance_id": request["engine_instance_id"], "bundle_hash": request["bundle_hash"], "operation": request["operation"], "payload_schema": request["payload_schema"], "status": "succeeded", "domain_result_schema": "pybert.simulation.v1", "artifacts": [{"schema": "sipi.artifact-ref.v1", "content_schema": "pybert.output.v1", "relative_path": "artifacts/result.json", "mime_type": "application/json", "sha256": "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", "byte_length": 1, "producer": "fixture.adapter", "role": "domain_result", "extensions": {}}], "events": [{"schema": "sipi.run-event.v1", "run_id": request["run_id"], "sequence": 0, "scope": "backend_execution", "stage": "completed", "elapsed_s": 0, "analysis_id": request["analysis_id"], "attempt_id": request["attempt_id"], "backend_execution_id": request["backend_execution_id"], "extensions": {}}], "warnings": [], "timings": {}, "resource_usage": {"actual_enforcement": {"wall_time_s": "monitor", "cpu_time_s": "unsupported", "memory_bytes": "unsupported", "process_count": "unsupported", "artifact_bytes": "unsupported"}}, "error": None}
