# -*- coding: utf-8 -*-
"""Fail closed on the P4A-03bg typed IBIS series pin Model Selector threshold parameters core.
...
evidence, Rust tokens, PLAN P4A-03bg.
"""
...
CHARTER = ROOT / "docs" / "baselines" / "p4a-03bg-series-pin-table-selector-thresholds-stage.v1.yaml"
SOURCE_MAP = ROOT / "docs" / "baselines" / "p4a-03bg-mit-source-map.v1.yaml"
EVIDENCE = ROOT / "docs" / "baselines" / "p4a-03bg-series-pin-table-selector-thresholds-crosscheck-evidence.v1.yaml"
SOURCE = ROOT / "crates" / "sipi-ibis" / "src" / "series_pin_mapping_table_selector_thresholds_binding_v1.rs"
PLAN = ROOT / "PLAN.md"
SCHEMA = "sipi.p4a-03bg.series-pin-table-selector-thresholds-stage.v1"
...
def validate(root: Path = ROOT) -> dict[str, Any]:
    ...
    if evidence.get("schema") != "sipi.p4a-03bg.series-pin-table-selector-thresholds-crosscheck-evidence.v1":
