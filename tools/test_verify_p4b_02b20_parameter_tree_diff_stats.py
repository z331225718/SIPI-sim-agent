# -*- coding: utf-8 -*-
"""Tests for the P4B-02b20 AMI parameter tree structural diff metrics verifier."""
...
import verify_p4b_02b20_parameter_tree_diff_stats as GATE


class ParameterTreeDiffStatsTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn compute_parameter_tree_diff_stats_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b20", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterTreeDiffStatsError):
                    GATE.validate(ROOT)
