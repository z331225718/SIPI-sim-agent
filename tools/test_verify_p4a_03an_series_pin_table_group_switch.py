# -*- coding: utf-8 -*-
"""Tests for the P4A-03an typed IBIS series pin group switch verifier."""
...
import verify_p4a_03an_series_pin_table_group_switch as GATE
...
class SeriesPinTableGroupSwitchTests(unittest.TestCase):
    ...
    def test_plan_row_present(self) -> None:
        self.assertIn("**P4A-03an", GATE.PLAN.read_text(encoding="utf-8"))
