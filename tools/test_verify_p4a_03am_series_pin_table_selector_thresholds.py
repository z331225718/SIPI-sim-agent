# -*- coding: utf-8 -*-
"""Tests for the P4A-03am typed IBIS series pin table selector threshold parameters verifier."""
...
import verify_p4a_03am_series_pin_table_selector_thresholds as GATE
...
class SeriesPinTableSelectorThresholdsTests(unittest.TestCase):
    ...
    def test_plan_row_present(self) -> None:
        self.assertIn("**P4A-03am", GATE.PLAN.read_text(encoding="utf-8"))
