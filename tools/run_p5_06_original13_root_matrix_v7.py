"""Run the extended-scalar original-13 matrix through the public root COM CLI.
...
try:
    from .run_p5_06_original13_extended_scalar_matrix_v1 import (
...
WORKER = Path(__file__).with_name("run_p5_06_original13_extended_scalar_matrix_v1.py")
