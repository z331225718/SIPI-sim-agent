# -*- coding: utf-8 -*-
"""Tests for the P4B-02b122 parameter list most-frequent item verifier."""
...
import verify_p4b_02b122_parameter_list_most_frequent as GATE


class ParameterListMostFrequentTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn most_frequent_parameter_list_item_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b122", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterListMostFrequentError):
                    GATE.validate(ROOT)
