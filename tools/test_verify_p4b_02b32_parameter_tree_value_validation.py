# -*- coding: utf-8 -*-
"""Tests for the P4B-02b32 AMI parameter tree leaf value validation verifier."""
...
import verify_p4b_02b32_parameter_tree_value_validation as GATE


class ParameterTreeValueValidationTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn validate_parameter_tree_values_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b32", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterTreeValueValidationError):
                    GATE.validate(ROOT)
