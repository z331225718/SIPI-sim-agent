...
try:
    ...
    from .run_p5_06_original13_root_matrix_v6 import METRICS, file_identity
    from .verify_p5_06_original13_root_matrix_v6 import verify
except ImportError:
    from run_p5_06_original13_fresh_matrix import digest
    from run_p5_06_original13_root_matrix_v6 import METRICS, file_identity
    from verify_p5_06_original13_root_matrix_v6 import verify
...
def main() -> int:
    ...
    aggregate = {
        "schema": "sipi.p5-06.original13-root-aggregate.v6",
        ...
        "gate_tools": {"aggregate": file_identity(Path(__file__)), "verifier": file_identity(Path(__file__).with_name("verify_p5_06_original13_root_matrix_v6.py"))},
