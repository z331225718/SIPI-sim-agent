"""Strict additive verifier for the v10 upstream integration ledger."""
...
LEDGER = ROOT / "docs/baselines/upstream-integration-ledger.v10.yaml"
SCHEMA = "sipi.upstream-integration-ledger.v10"
COMMIT = "f628d7f0660667fe6a79b7a39ea5a3e3b4500a4e"
TREE = "5d3cd3e04cb495fab85b247130b8f0b236b6e6a9"
ARCHIVE = "754d7c38a136d82fa52c822b3b0090d505ffc97a23259256265bf338101126a8"
ARCHIVE_BYTES = 51988480
V9_PATH = "docs/baselines/upstream-integration-ledger.v9.yaml"
V9_SHA = "de63edd031cf7850817d33085afa8b5729f65f1e9f65a5ce9545a8c0f7b2da35"
PLAN_PATH = "PLAN.md"
EXPECTED_PLAN_SHA = "cbdf15049e9e939f427dd8c26688e132bff84fee81c9d5a58b9717d2b94efe16"
AUDIT_PATH = "docs/baselines/audits/2026-08-25-upstream-integration-ledger-v10.md"
MUTATION_TEST_PATH = "tools/test_verify_upstream_integration_ledger_v10.py"
EXPECTED_AUDIT_SHA = "af2fcfa7d323eb607faa7b8847cc15422ef1290b5b0a80e09840b283bceebfbc"
EXPECTED_VERIFIER_SHA = "0df7798920f82296a6f3b287baebc3d8de59e8d143b6d0307d9d9e159809b7f3"
EXPECTED_MUTATION_SHA = "c088151d320c96c52b4bde611a5cbb3ea5f7c8c123480b53075ec2bf35585093"
PLAN_MARKER = "2026-08-25 v10 upstream-first 治理收口"
...
EXPECTED_OBSERVATION_SHA256_BY_ROW = {
    ...
    "AS-04": "2d5010a8b69341c2083b63a9e1292c434cbe2e68cc7d0aeeb588d391bb959561",
    "AS-05": "925615969220329de0125caf3c6d91f5660af314b377e420c0a0915182576ae0",
    "AS-06": "aa672eb06cb91d640ddc53272261d2023450e894efd1ec52c85cd60248c858b5",
    "PB-01": "000afef119eb33ab3904ca7cb2ec845ccf6ce878efd34963eb2a6acfeb1272e8",
    ...
    "COM-02": "24d785d1186e02251c112fb3a61bb90dc3f6a4af900bd52d76b4e34669b3e61f",
...
SOURCE_BINDINGS = {
    ...
    "as04_source_map": ("docs/baselines/as-04-tune-yparam-tran-source-map.v1.yaml", "23fb2c2f124d71dd7f229ee814c4ebf686227a6a48ec579c575977051974ec62"),
    ...
    "as06_source_map": ("docs/baselines/as-06-run-rfm-source-map.v2.yaml", "8aa1586ed673e8dddceefa875a33f537295e897f1cf2a4e785887577eb834773"),
    "as06_notice": ("crates/sipi-agent-spice-direct/NOTICE-AGENT-SPICE-AS-06-v2.md", "027e42bc0d1c627d260fa88c4389acd558551b41127406a08587a013ad74b9f7"),
...
def _sha(path: Path) -> str:
    ...
    if path.resolve() == (ROOT / "tools/verify_upstream_integration_ledger_v10.py").resolve():
    ...
    if path.resolve() == (ROOT / "tools/test_verify_upstream_integration_ledger_v10.py").resolve():
...
def _validate(document: dict[str, Any]) -> dict[str, Any]:
    ...
    _require(document["successor"] == {"predecessor": V9_PATH, "predecessor_sha256": V9_SHA, "reason": "additive v10 governance closeout; v1-v9 remain immutable historical ledgers"}, "successor")
    _require(_sha(ROOT / V9_PATH) == V9_SHA, "predecessor_hash")
    ...
    _require(by_id["AS-06"]["current_observation"]["external_execution"] == "attested_ngspice_rfm_workflow" and by_id["AS-06"]["current_observation"]["solver_boundary"] == "retained_external_solver", "AS-06:scope")
    ...
    _require(com02_observation["commit"] == COMMIT and com02_observation["trusted_workbook_port_order"] == "unbound_manual_two_case_observation" and com02_observation["opaque_winner_final_metrics"] == "unbound_manual_two_case_observation" and com02_observation["formal_evidence"] is False and com02_observation["v4_formal_support"] is False and com02_observation["channel_policy"] == "impulse_only" and com02_observation["s_parameter_fit"] == "forbidden" and com02_observation["global_parity"] is False and com02_observation["release"] is False, "COM-02:scope")
    ...
    _require(PLAN_MARKER in plan_text and "upstream-integration-ledger.v10" in plan_text and "15/15" in plan_text and "release-ready=0" in plan_text, "plan_marker")
    ...
    for marker in (SCHEMA, COMMIT, TREE, ARCHIVE, "15 rows", "release-ready=0", "AS-01", "AS-05", "AS-06", "PB-02", "flat", "Temp", "COM-02", "unbound_manual_two_case_observation", "not formal evidence", "not supported by v4", "impulse-only", "No v9 file"):
    ...
    _require(harness["verifier"]["path"] == "tools/verify_upstream_integration_ledger_v10.py" and harness["mutation_tests"]["path"] == "tools/test_verify_upstream_integration_ledger_v10.py", "harness_paths")
