# -*- coding: utf-8 -*-
"""Tests for the P4B-02b33 AMI parameter tree leaf value type inference verifier."""
...
import verify_p4b_02b33_parameter_tree_value_type_inference as GATE


class ParameterTreeTypeInferenceTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn infer_parameter_tree_leaf_types_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b33", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterTreeTypeInferenceError):
                    GATE.validate(ROOT)
