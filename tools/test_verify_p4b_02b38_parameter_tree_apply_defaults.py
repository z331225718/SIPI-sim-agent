# -*- coding: utf-8 -*-
"""Tests for the P4B-02b38 AMI parameter tree defaults application verifier."""
...
import verify_p4b_02b38_parameter_tree_apply_defaults as GATE


class ParameterTreeApplyDefaultsTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn apply_parameter_tree_defaults_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b38", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterTreeDefaultsError):
                    GATE.validate(ROOT)
