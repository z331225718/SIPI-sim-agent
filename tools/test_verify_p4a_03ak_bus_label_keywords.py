# -*- coding: utf-8 -*-
"""Tests for the P4A-03ak typed IBIS bus label block keywords verifier."""
...
import verify_p4a_03ak_bus_label_keywords as GATE


class BusLabelKeywordsTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn lift_bus_label_block_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4A-03ak", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.BusLabelKeywordsError):
                    GATE.validate(ROOT)
