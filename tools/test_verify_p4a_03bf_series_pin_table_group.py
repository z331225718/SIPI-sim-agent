# -*- coding: utf-8 -*-
"""Tests for the P4A-03bf typed IBIS series pin group model binding verifier."""
...
import verify_p4a_03bf_series_pin_table_group as GATE
...
class SeriesPinTableGroupTests(unittest.TestCase):
    ...
    def test_plan_row_present(self) -> None:
        self.assertIn("**P4A-03bf", GATE.PLAN.read_text(encoding="utf-8"))
