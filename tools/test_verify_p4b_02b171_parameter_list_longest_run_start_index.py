# -*- coding: utf-8 -*-
"""Tests for the P4B-02b171 parameter list longest run start index verifier."""
...
import verify_p4b_02b171_parameter_list_longest_run_start_index as GATE


class ParameterListLongestRunStartIndexTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn parameter_list_longest_run_start_index_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b171", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterListLongestRunStartIndexError):
                    GATE.validate(ROOT)
