"""Run one full, immutable P5-06s original-13 v4 matrix replay.
...
SCHEMA = "sipi.p5-06.original13-fresh-run.v4"
...
def main() -> int:
    ...
    report = {
        "schema": SCHEMA, "engine": args.engine, "run_id": f"original13-v4-{args.engine}-{nonce}", "nonce": nonce,
