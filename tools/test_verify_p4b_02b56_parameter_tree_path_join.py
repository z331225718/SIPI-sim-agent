# -*- coding: utf-8 -*-
"""Tests for the P4B-02b56 parameter tree path join verifier."""
...
import verify_p4b_02b56_parameter_tree_path_join as GATE


class ParameterTreePathJoinTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn join_parameter_tree_path_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b56", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterTreePathJoinError):
                    GATE.validate(ROOT)
