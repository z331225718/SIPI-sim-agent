# -*- coding: utf-8 -*-
"""Tests for the P4B-02b114 parameter list split-at-index verifier."""
...
import verify_p4b_02b114_parameter_list_split as GATE


class ParameterListSplitTests(unittest.TestCase):
    ...
    def test_evidence_matched_five_cases(self) -> None:
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn split_parameter_list_at_index_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b114", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterListSplitError):
                    GATE.validate(ROOT)
