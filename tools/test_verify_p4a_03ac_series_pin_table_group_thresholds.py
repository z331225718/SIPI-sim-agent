# -*- coding: utf-8 -*-
"""Tests for the P4A-03ac typed IBIS series pin group threshold table verifier."""
...
import verify_p4a_03ac_series_pin_table_group_thresholds as GATE
...
class SeriesPinTableGroupThresholdsTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn lift_series_pin_group_threshold_record_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4A-03ac", GATE.PLAN.read_text(encoding="utf-8"))
