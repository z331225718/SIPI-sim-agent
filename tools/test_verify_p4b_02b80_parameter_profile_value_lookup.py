# -*- coding: utf-8 -*-
"""Tests for the P4B-02b80 parameter profile value lookup verifier."""
...
import verify_p4b_02b80_parameter_profile_value_lookup as GATE


class ParameterProfileValueLookupTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn find_parameter_profile_names_by_value_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b80", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterProfileValueLookupError):
                    GATE.validate(ROOT)
