# -*- coding: utf-8 -*-
"""Tests for the P4B-02b29 AMI parameter tree depth statistics verifier."""
...
import verify_p4b_02b29_parameter_tree_depth_stats as GATE


class ParameterTreeDepthStatsTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn compute_parameter_tree_depth_stats_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b29", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterTreeDepthStatsError):
                    GATE.validate(ROOT)
