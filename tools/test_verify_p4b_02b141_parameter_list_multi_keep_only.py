# -*- coding: utf-8 -*-
"""Tests for the P4B-02b141 parameter list multi-value keep-only verifier."""
...
import verify_p4b_02b141_parameter_list_multi_keep_only as GATE


class ParameterListMultiKeepOnlyTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn keep_only_parameter_list_items_multi_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b141", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterListMultiKeepOnlyError):
                    GATE.validate(ROOT)
