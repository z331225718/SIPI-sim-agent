# -*- coding: utf-8 -*-
"""Tests for the P4B-02b66 parameter tree relative path verifier."""
...
import verify_p4b_02b66_parameter_tree_relative_path as GATE


class ParameterTreeRelativePathTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn relative_parameter_tree_path_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b66", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterTreeRelativePathError):
                    GATE.validate(ROOT)
