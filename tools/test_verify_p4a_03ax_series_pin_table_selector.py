# -*- coding: utf-8 -*-
"""Tests for the P4A-03ax typed IBIS series pin Model Selector binding verifier."""
...
import verify_p4a_03ax_series_pin_table_selector as GATE
...
class SeriesPinTableSelectorTests(unittest.TestCase):
    ...
    def test_plan_row_present(self) -> None:
        self.assertIn("**P4A-03ax", GATE.PLAN.read_text(encoding="utf-8"))
