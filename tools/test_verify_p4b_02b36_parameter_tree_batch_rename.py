# -*- coding: utf-8 -*-
"""Tests for the P4B-02b36 AMI parameter tree batch rename verifier."""
...
import verify_p4b_02b36_parameter_tree_batch_rename as GATE


class ParameterTreeBatchRenameTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn rename_parameter_tree_leaves_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b36", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterTreeBatchRenameError):
                    GATE.validate(ROOT)
