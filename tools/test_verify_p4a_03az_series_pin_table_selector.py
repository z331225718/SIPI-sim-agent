# -*- coding: utf-8 -*-
"""Tests for the P4A-03az typed IBIS series pin Model Selector binding verifier."""
...
import verify_p4a_03az_series_pin_table_selector as GATE
...
class SeriesPinTableSelectorTests(unittest.TestCase):
    ...
    def test_plan_row_present(self) -> None:
        self.assertIn("**P4A-03az", GATE.PLAN.read_text(encoding="utf-8"))
