# -*- coding: utf-8 -*-
"""Fail closed on the P4A-03w typed IBIS series pin table selector core.

Charter fixes the series pin table selector scope; cross-check evidence binds product
lifting against an independent reference. Verifier binds charter, source map,
evidence, Rust tokens, PLAN P4A-03w.
"""
...
CHARTER = ROOT / "docs" / "baselines" / "p4a-03w-series-pin-table-selector-stage.v1.yaml"
SOURCE_MAP = ROOT / "docs" / "baselines" / "p4a-03w-mit-source-map.v1.yaml"
EVIDENCE = ROOT / "docs" / "baselines" / "p4a-03w-series-pin-table-selector-crosscheck-evidence.v1.yaml"
SOURCE = ROOT / "crates" / "sipi-ibis" / "src" / "series_pin_mapping_table_selector_v1.rs"
PLAN = ROOT / "PLAN.md"
SCHEMA = "sipi.p4a-03w.series-pin-table-selector-stage.v1"
POLICY = "sipi.p4a-03w.series-pin-table-selector-v1.typed-selector"
...
def validate(root: Path = ROOT) -> dict[str, Any]:
    ...
    if evidence.get("schema") != "sipi.p4a-03w.series-pin-table-selector-crosscheck-evidence.v1":
