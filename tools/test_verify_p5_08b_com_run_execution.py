# -*- coding: utf-8 -*-
"""Tests for the P5-08b COM run execution and result envelope verifier."""
...
import verify_p5_08b_com_run_execution as GATE


class ComRunExecutionTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn execute_com_run_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P5-08b", GATE.PLAN.read_text(encoding="utf-8"))
