# -*- coding: utf-8 -*-
"""Tests for the P4B-02b69 parameter tree profile apply verifier."""
...
import verify_p4b_02b69_parameter_tree_profile_apply as GATE


class ParameterTreeProfileApplyTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn apply_parameter_profile_to_tree_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b69", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterTreeProfileApplyError):
                    GATE.validate(ROOT)
