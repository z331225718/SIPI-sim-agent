...
def expected() -> dict:
    return {
        ...
        "observed_interpretation": {"exact_grid_impulse_diagnostic_observed": True, "finite_band_raw_quadrature_has_material_negative_time_content": True, "threshold_selected": False, "causal_impulse_admitted": False, "sampled_four_port_passivity_admitted": False, "causal_repair_or_delay_shift_applied": False, "product_impulse_execution_implemented": False},
