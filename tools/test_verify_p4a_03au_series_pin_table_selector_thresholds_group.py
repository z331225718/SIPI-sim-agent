# -*- coding: utf-8 -*-
"""Tests for the P4A-03au typed IBIS series pin Model Selector group threshold parameters verifier."""
...
import verify_p4a_03au_series_pin_table_selector_thresholds_group as GATE
...
class SeriesPinTableSelectorThresholdsGroupTests(unittest.TestCase):
    ...
    def test_plan_row_present(self) -> None:
        self.assertIn("**P4A-03au", GATE.PLAN.read_text(encoding="utf-8"))
