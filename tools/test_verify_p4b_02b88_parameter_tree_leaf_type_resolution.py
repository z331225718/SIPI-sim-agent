# -*- coding: utf-8 -*-
"""Tests for the P4B-02b88 parameter tree leaf type resolution verifier."""
...
import verify_p4b_02b88_parameter_tree_leaf_type_resolution as GATE


class ParameterTreeLeafTypeResolutionTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn resolve_parameter_tree_leaf_type_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b88", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterTreeLeafTypeResolutionError):
                    GATE.validate(ROOT)
