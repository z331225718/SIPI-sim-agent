# -*- coding: utf-8 -*-
"""Tests for the P4B-02b18 AMI parameter tree predicate filtering verifier."""
...
import verify_p4b_02b18_parameter_tree_filter as GATE


class ParameterTreeFilterTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn filter_parameter_trees_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b18", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterTreeFilterError):
                    GATE.validate(ROOT)
