# -*- coding: utf-8 -*-
"""Tests for the P4A-03ao typed IBIS series pin group switch threshold parameters verifier."""
...
import verify_p4a_03ao_series_pin_table_group_switch_thresholds as GATE
...
class SeriesPinTableGroupSwitchThresholdsTests(unittest.TestCase):
    ...
    def test_plan_row_present(self) -> None:
        self.assertIn("**P4A-03ao", GATE.PLAN.read_text(encoding="utf-8"))
