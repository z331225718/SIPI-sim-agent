# -*- coding: utf-8 -*-
"""Tests for the P4A-03ap typed IBIS series pin group Model Selector threshold parameters verifier."""
...
import verify_p4a_03ap_series_pin_table_selector_group_thresholds as GATE
...
class SeriesPinTableSelectorGroupThresholdsTests(unittest.TestCase):
    ...
    def test_plan_row_present(self) -> None:
        self.assertIn("**P4A-03ap", GATE.PLAN.read_text(encoding="utf-8"))
