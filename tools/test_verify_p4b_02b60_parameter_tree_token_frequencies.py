# -*- coding: utf-8 -*-
"""Tests for the P4B-02b60 parameter tree token frequencies verifier."""
...
import verify_p4b_02b60_parameter_tree_token_frequencies as GATE


class ParameterTreeTokenFrequenciesTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn compute_parameter_tree_token_frequencies_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b60", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterTreeTokenFrequenciesError):
                    GATE.validate(ROOT)
