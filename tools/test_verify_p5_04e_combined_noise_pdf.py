"""Tests for the P5-04e combined noise PDF verifier."""
...
import verify_p5_04e_combined_noise_pdf as GATE
...
class CombinedPdfTests(unittest.TestCase):
    ...
    def test_plan_row_present(self) -> None:
        ...
        self.assertIn("**P5-04e", plan_text)

    def test_rejects_sampled_pdf_admission(self) -> None:
        import copy
        import tempfile
        import unittest.mock as mock
        charter = copy.deepcopy(GATE.load_yaml(GATE.CHARTER))
        charter["admission"]["sampled_signal_pdf"] = True
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "CHARTER", tmp_path):
                with self.assertRaises(GATE.CombinedPdfError):
                    GATE.validate(ROOT)
