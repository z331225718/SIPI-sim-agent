# -*- coding: utf-8 -*-
"""Tests for the P4B-02b152 parameter list multiset equality verifier."""
...
import verify_p4b_02b152_parameter_list_multiset_equal as GATE


class ParameterListMultisetEqualTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn list_multiset_equal_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b152", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterListMultisetEqualError):
                    GATE.validate(ROOT)
