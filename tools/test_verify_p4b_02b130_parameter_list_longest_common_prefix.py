# -*- coding: utf-8 -*-
"""Tests for the P4B-02b130 parameter list longest common prefix verifier."""
...
import verify_p4b_02b130_parameter_list_longest_common_prefix as GATE


class ParameterListLongestCommonPrefixTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn list_longest_common_prefix_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b130", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterListLongestCommonPrefixError):
                    GATE.validate(ROOT)
