...
SCHEMA = "sipi.com-01-direct-port-differential.v2"
...
def _value_projection(value: Any, fixture: Path) -> Any:
    """Compare the full public materialized artifact, excluding path custody."""
    return _normal_form(value, fixture)
...
def compare_scenario(
    ...
    oracle_code, oracle_stdout, oracle_stderr = _run(
        [str(uv), "run", "--frozen", "--offline", "python", "-m", "agent_com.cli", *args],
        cwd=agent_com_root,
