# -*- coding: utf-8 -*-
"""Tests for the P4B-02b25 AMI parameter tree cycle detection verifier."""
...
import verify_p4b_02b25_parameter_tree_detect_cycles as GATE


class ParameterTreeDetectCyclesTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn detect_parameter_tree_cycles_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b25", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterTreeDetectCyclesError):
                    GATE.validate(ROOT)
