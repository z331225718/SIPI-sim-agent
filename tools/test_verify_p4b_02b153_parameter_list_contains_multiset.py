# -*- coding: utf-8 -*-
"""Tests for the P4B-02b153 parameter list multiset containment verifier."""
...
import verify_p4b_02b153_parameter_list_contains_multiset as GATE


class ParameterListContainsMultisetTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn list_contains_multiset_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b153", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterListContainsMultisetError):
                    GATE.validate(ROOT)
