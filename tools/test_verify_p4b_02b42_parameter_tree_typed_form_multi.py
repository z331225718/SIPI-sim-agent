# -*- coding: utf-8 -*-
"""Tests for the P4B-02b42 AMI parameter tree multi-tree typed-form extraction verifier."""
...
import verify_p4b_02b42_parameter_tree_typed_form_multi as GATE


class ParameterTreeTypedFormMultiTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn extract_typed_parameter_forms_multi_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4B-02b42", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.ParameterTreeMultiFormError):
                    GATE.validate(ROOT)
