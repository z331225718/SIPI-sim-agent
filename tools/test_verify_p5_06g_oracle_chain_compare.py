# -*- coding: utf-8 -*-
"""Tests for the P5-06g product COM chain oracle-checkpoint compare verifier."""
...
import verify_p5_06g_oracle_chain_compare as GATE


class OracleChainCompareTests(unittest.TestCase):
    ...
    def test_plan_row_present(self) -> None:
        self.assertIn("**P5-06g", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.OracleChainCompareError):
                    GATE.validate(ROOT)
