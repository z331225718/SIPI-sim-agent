# -*- coding: utf-8 -*-
"""Tests for the P4A-03h typed IBIS package model declaration verifier."""
...
import verify_p4a_03h_package_model as GATE
...
class PackageModelTests(unittest.TestCase):
    ...
    def test_implementation_tokens_present(self) -> None:
        ...
        self.assertIn("pub fn lift_package_model_declaration_v1", source)
        self.assertIn(GATE.POLICY, source)

    def test_plan_row_present(self) -> None:
        self.assertIn("**P4A-03h", GATE.PLAN.read_text(encoding="utf-8"))
    ...
    def test_rejects_evidence_mismatch(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.object(GATE, "EVIDENCE", tmp_path):
                with self.assertRaises(GATE.PackageModelError):
                    GATE.validate(ROOT)
