...
- [ ] **P4A-04** 实现 required I-V/V-T/ramp/package 语义与显式 interpolation/extrapolation policy。
  ...
  - [ ] **P4A-04c** selected DC clamp decoder/protocol：将产品自有 structural/semantic document 严格解码为 selected Typical Input 的 `C_comp` 与 ground/power clamp typed tables；仅冻结 observer exchange protocol，two-fresh-custody external comparison 留待 P4A-04d。
