...
- **P7-06g 前置 P0 修复进行中：** 已检测到普通 Windows checkout 对 byte-hashed 根治理文件的 CRLF 表现与 Git blob/`git archive` LF 表现分裂；在 canonical-LF P0 重绑提交完成前，不得将任一 checkout 结果用于当前 P7 composition。
