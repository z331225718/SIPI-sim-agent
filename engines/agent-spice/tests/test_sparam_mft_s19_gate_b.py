...
from scripts.sparam_mft_s19_gate_b import classify_gate_b, overall_gate_status
...
def test_gate_b_overall_preserves_collapse_diagnosis() -> None:
    assert overall_gate_status(["COLLAPSE_DIAGNOSIS"]) == "COLLAPSE_DIAGNOSIS"
