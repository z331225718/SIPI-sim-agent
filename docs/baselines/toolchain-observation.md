...
| --- | --- | --- |
| Python | uv CPython 3.12.13；默认 `python` 为 3.14.5 | selected, not yet isolated-verified |
...
| XDM | 2.6 | declared by solver lock, not on PATH |
...
This is a provisional M0-03 observation. Its exit gate still requires an isolated reproduction and a pinned GitNexus invocation.
