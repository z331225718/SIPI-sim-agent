# AS-05 run-hspice-rust-control immutable v2 audit
...
The two reports are immutable-archive-bound, independently nonce/run-id tagged, report-SHA distinct, and use the same recorded cargo/rustc/python identities. deck/project/conversion observation; external backends and S-element export fail-closed. No numerical parity or acceptance tolerance is claimed.
