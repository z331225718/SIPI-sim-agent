# AS-03 fit-yparam immutable v2 audit
...
The two reports are immutable-archive-bound, independently nonce/run-id tagged, report-SHA distinct, and use the same recorded cargo/rustc/python identities. portable n-port/KYP observation; numerical parity remains open. No numerical parity or acceptance tolerance is claimed.
