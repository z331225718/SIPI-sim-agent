# P4A-03au Typed IBIS Series Pin Mapping Model Selector Group Threshold Table Core — Audit Record

- Date (UTC): 2026-08-16
- Scope: P4A-03 sub-slice 03au (typed IBIS [Series Pin Mapping] Model Selector group threshold table binding core)
...
- Cross-check: 3 test cases (full selector group threshold record, minimal selector group threshold record, empty pin name)
  driven through product runner `p4a_03au_series_pin_table_selector_thresholds_group_runner`; independent Python reference
...
- Verifier `verify_p4a_03au_series_pin_table_selector_thresholds_group.py` + 6 tests; crosscheck evidence
  `docs/baselines/p4a-03au-series-pin-table-selector-thresholds-group-crosscheck-evidence.v1.yaml`.
- Charter `p4a-03au-series-pin-table-selector-thresholds-group-stage.v1.yaml`; source map
  `p4a-03au-mit-source-map.v1.yaml`.
- PLAN **P4A-03au**; ledger note/gate P4A-03; coverage gates 176 -> 177.
