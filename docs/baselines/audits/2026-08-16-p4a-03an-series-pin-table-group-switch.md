# P4A-03an Typed IBIS Series Pin Mapping Group Switch Association Core — Audit Record

- Date (UTC): 2026-08-16
- Scope: P4A-03 sub-slice 03an (typed IBIS [Series Pin Mapping] group switch association core)
...
- Cross-check: 3 test cases (full group switch record, minimal group switch record, identical state groups)
  driven through product runner `p4a_03an_series_pin_table_group_switch_runner`; independent Python reference
...
- Verifier `verify_p4a_03an_series_pin_table_group_switch.py` + 6 tests; crosscheck evidence
  `docs/baselines/p4a-03an-series-pin-table-group-switch-crosscheck-evidence.v1.yaml`.
- Charter `p4a-03an-series-pin-table-group-switch-stage.v1.yaml`; source map
  `p4a-03an-mit-source-map.v1.yaml`.
- PLAN **P4A-03an**; ledger note/gate P4A-03; coverage gates 168 -> 169.
