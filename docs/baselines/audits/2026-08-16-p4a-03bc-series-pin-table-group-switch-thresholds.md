# P4A-03bc Typed IBIS Series Pin Mapping Group Switch Threshold Table Core — Audit Record

- Date (UTC): 2026-08-16
- Scope: P4A-03 sub-slice 03bc (typed IBIS [Series Pin Mapping] group switch threshold table binding core)
...
- Cross-check: 3 test cases (full group switch threshold record, minimal group switch threshold record, identical state groups)
  driven through product runner `p4a_03bc_series_pin_table_group_switch_thresholds_runner`; independent Python reference
...
- Verifier `verify_p4a_03bc_series_pin_table_group_switch_thresholds.py` + 6 tests; crosscheck evidence
  `docs/baselines/p4a-03bc-series-pin-table-group-switch-thresholds-crosscheck-evidence.v1.yaml`.
- Charter `p4a-03bc-series-pin-table-group-switch-thresholds-stage.v1.yaml`; source map
  `p4a-03bc-mit-source-map.v1.yaml`.
- PLAN **P4A-03bc**; ledger note/gate P4A-03; coverage gates 184 -> 185.
