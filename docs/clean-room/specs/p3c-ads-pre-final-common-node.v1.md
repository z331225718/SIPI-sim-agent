...
tolerance, or product policy.  It records only hashes and aggregate,
non-payload full-matrix and selected-Hdiff summaries.  It is not a passivity
algorithm or correction-magnitude claim, and changes no product or release
gate.
